...
\IFRU{(с префиксом \TT{LOCK}) нулевой бит сохраняется в флаге CF и очищается в памяти}
{(prefixed with \TT{LOCK}) the zeroth bit is stored in CF flag and cleared in memory}.
