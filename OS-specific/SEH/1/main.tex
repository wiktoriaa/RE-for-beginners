...
\footnote{\IFRU{Он должен компилироваться с опцией}{It is compiled with the} SAFESEH\IFRU{}{ option}: 
\TT{cl seh1.cpp /link /safeseh:no}}
\footnote{\href{http://msdn.microsoft.com/en-us/library/9a89h429.aspx}
...
\begin[caption=MSVC/VC/crt/src/exsup.inc]{lstlisting}
