...
\begin{tikzpicture}[thick,scale=0.85, every node/.style={scale=0.85}]
	...
	\node (n3prev_pt) [inner sep=0pt, left=0.5cm of n3prev] {};
	\draw [->] (n3prev.west) -- (n3prev_pt) -- (n2block_pt2) -- (n2block_pt1);
	...
	\node (n2prev_pt) [inner sep=0pt, left=0.8cm of n2prev] {};
	\draw [->] (n2prev.west) -- (n2prev_pt) -- (n1block_pt2) -- (n1block_pt1);
	
	\node (tib_block_pt1) [inner sep=0pt, right=1.25cm of tib1.east] {};
	...
	\draw [->] (tib1.east) -- (tib_block_pt1) -- (n3block_pt2) -- (n3block_pt1);
