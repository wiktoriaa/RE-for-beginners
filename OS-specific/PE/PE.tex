...
\IT{IMAGE\_SCN\_CNT\_CODE} \OrENRU \IT{IMAGE\_SCN\_MEM\_EXECUTE}\IFRU{}{ on code section}\EMDASH\IFRU{это исполняемый код}{this is executable code}.
...
even, if one does not have special knowledge, e.g. using} ResHack\IFRU{}{ editor}(\ref{ResHack}).
