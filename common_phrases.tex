...
\EN{These instructions are also called}\PTBR{Estas intruções também são chamadas}
...
instructions to other ones}\PTBR{Substituição de instruções aritiméticas por outras}\ES{Substituición de instrucciones aritméticas por otros}}
