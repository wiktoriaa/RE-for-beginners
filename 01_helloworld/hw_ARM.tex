...
{write address after \TT{BL} instruction (\TT{0xC}) into \LRwithfootnote register};
\item
...
\IFRU{Инструкция \MOV просто записывает число \TT{0x1686} в регистр \Rzero, это смещение указывающее на строку ``Hello world!''}{\MOV instruction just writes \TT{0x1686} number into \Rzero register, this is offset pointing to the ``Hello world!'' string}.
