...
\IFRU{Её название не очень удачное: в других архитектурах подобная инструкция обычно носит название 
``load'' или что-то в этом роде}{Its name is not felicitous: this instruction in other 
architectures has name ``load'' or something like that}.
