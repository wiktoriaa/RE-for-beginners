...
in other words, this instruction sets the stack pointer (\ESP) back and restores 
...
{Before register names a percent sign should be written (\%) and before numbers a dollar sign (\$).}
