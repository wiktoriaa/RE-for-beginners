...
{Since our \main function is usually the primary function in \CCpp, control will be returned to \ac{OS} loader or to a point in the runtime C functions, or something like that}.
