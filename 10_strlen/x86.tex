...
{About first: \MOVSX is intended to take byte from some point in memory and store value in 32-bit register. 
...
{Now it is all simpler. But it is needless to say that compiler could use registers such efficiently 
...
But I'm assure that both variants are effectively equivalent in efficiency sense.}
