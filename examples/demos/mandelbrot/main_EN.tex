...
\clearpage
\subsectionold{Theory}

\subsubsectionold{A word about complex numbers}
...
\subsubsectionold{How to draw the Mandelbrot set}
...
\begin{figure}[H]
\centering
\myincludegraphics{examples/demos/mandelbrot/demo1.png}
...
\begin{figure}[H]
\centering
\myincludegraphics{examples/demos/mandelbrot/demo2.png}
...
\clearpage
\subsectionold{Let's get back to the demo}
