...
\lstinputlisting[caption=Commented source code,numbers=left,style=customasm]{examples/demos/mandelbrot/Microbrot_commented_EN.asm}
...
\lstinputlisting[caption=\MyFixedVersion,numbers=left,style=customasm]{examples/demos/mandelbrot/my_version_EN.asm}
