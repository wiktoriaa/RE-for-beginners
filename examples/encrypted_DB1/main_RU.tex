...
Это означает что знаения энтропии не очень отличаются друг от друга.
...
которые можно использовать в время применения операции XOR, но кто заставляет нас использовать все 16 байт?
