...
\lstinputlisting[style=customasm]{examples/encrypted_DB1/1.lst}
...
\lstinputlisting[style=customasm]{examples/encrypted_DB1/2.lst}
...
\lstinputlisting[style=customasm]{examples/encrypted_DB1/tails.lst}
