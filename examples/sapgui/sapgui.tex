\subsection{\IFRU{Касательно сжимания сетевого траффика в клиенте SAP}{About SAP client network traffic compression}}
\label{sec:SAPGUI}
...
\IFRU{Тут так же имеются манипуляции со строками при помощи функций из MFC}
...
\IFRU{Посмотрим содержимое функции ``надоедливого всплывающего окна''}
...
\dots \IFRU{заменим просто на \JMP и получим SAPGUI работающим без этого надоедливого всплывающего окна!}
