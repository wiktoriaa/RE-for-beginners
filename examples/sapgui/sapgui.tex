...
{I'm starting to search for all occurences of \TT{0x15} value in code. 
For a small programs like SAPGUI, it sometimes works. Here is the first occurence I got:}
...
{Now let's dig across SAPguilib.dll for \TT{0x3A4} value. And here is the second occurence in 
