...
the nagging pop-up window and actual data compression routine.)}
...
(\IFRU{чиайте}{read} \href{http://blog.yurichev.com/node/44}{\IFRU{здесь}{here}} \IFRU{и}{and} \href{http://blog.yurichev.com/node/47}{\IFRU{здесь}{here}}). 
