...
переписать всё это на Си вручную}\EN{ is not in list of our posessions, or we distrust to it, 
...
\RU{На строке 7 мы видим объявление переменных}\EN{We see variable difinitions on line 7}.
...
\EN{Let's be more sadistic and add another constaint: last 16-bit should be} \TT{0x1234}:
