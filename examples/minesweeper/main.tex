...
\RU{Я запустил Сапёр, присоединил (attach) \olly к нему и увидел содержимое памяти по адресу где массив \TT{rgBlk} (\TT{0x01005340})}
\EN{I ran Minesweeper, attaching \olly to it and I now see the memory dump at the address of the \TT{rgBlk} array (\TT{0x01005340})}
