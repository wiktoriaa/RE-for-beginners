...
\lstinputlisting[style=customasm]{examples/minesweeper/1.lst}
...
\lstinputlisting[style=customasm]{examples/minesweeper/2.lst}

Now we'll remove all \IT{border bytes} (0x10) and what's beyond those:

\lstinputlisting[style=customasm]{examples/minesweeper/3.lst}
...
%Hint: \myref{minesweeper_winxp_hint}.
%Hint: 
%think about  \IT{border bytes} (0x10).
