...
The utility should be run like that: \TT{./cointool-overclock 0 0 900}, where 900 is frequency in MHz.
...
I didn't go further, but if I need to, I would try to decrease a value which is passed to \TT{write\_power()} function.
