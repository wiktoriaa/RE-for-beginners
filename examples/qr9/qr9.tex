...
{Value in the \TT{DL} is 1 here. Shift left it by arg\_8. For example, if arg\_8 is 4, value in the \TT{DL} register became 
...
DL except those in \TT{DL} which are cleared. This means that if \TT{DL} is, for example, 
