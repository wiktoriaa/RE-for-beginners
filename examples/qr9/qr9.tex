...
\RU{Записываем шифрованный буфер}\EN{Write crypted buffer}:
...
\EN{Copy crypted contents back from ``cube64'' to buffer}:
...
тогда значение в \TT{DL} станет 0x10 или 1000 в двоичной системе счисления.}
...
\RU{\dots инвертировать DL. Например, если состояние DL после сдвига 0x10 или 1000 в двоичной системе,
здесь будет 0xEF после инструкции \NOT или 11101111 в двоичной системе.}
\EN{\dots invert DL. For example, if DL state after shift was 0x10 or 1000 in binary form, 
...
This means that if \TT{DL} is e.g. $11101111$ in binary form,
...
\footnote{\url{http://en.wikipedia.org/wiki/Rubik's_Cube}}?!
...
strrev() \footnote{\url{http://msdn.microsoft.com/en-us/library/9hby7w40(VS.80).aspx}}
