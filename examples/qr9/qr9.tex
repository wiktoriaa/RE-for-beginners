...
\RU{Этот фрагмент кода копирует часть входного буфера во внутренний буфер, который я позже назвал \q{cube64}.}
\EN{This fragment of code copies a part of the input buffer to an internal array I later named \q{cube64}.}
