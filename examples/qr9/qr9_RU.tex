...
% TODO translate:
\lstinputlisting[style=customasm]{examples/qr9/qr9_original.lst}
...
\lstinputlisting[style=customasm]{examples/qr9/1_RU}
...
\lstinputlisting[style=customasm]{examples/qr9/2_RU}
...
\lstinputlisting[style=customasm]{examples/qr9/3_RU}
...
\lstinputlisting[style=customasm]{examples/qr9/4_RU}
...
\lstinputlisting[style=customasm]{examples/qr9/5_RU}
...
\lstinputlisting[style=customasm]{examples/qr9/6_RU}
...
\lstinputlisting[style=customasm]{examples/qr9/7_RU}
