...
\lstinputlisting[style=customasm]{examples/qr9/1_EN}
...
\lstinputlisting[style=customasm]{examples/qr9/2_EN}
...
\lstinputlisting[style=customasm]{examples/qr9/3_EN}
...
\lstinputlisting[style=customasm]{examples/qr9/4_EN}
...
\lstinputlisting[style=customasm]{examples/qr9/5_EN}
...
\lstinputlisting[style=customasm]{examples/qr9/6_EN}
...
\lstinputlisting[style=customasm]{examples/qr9/7_EN}
