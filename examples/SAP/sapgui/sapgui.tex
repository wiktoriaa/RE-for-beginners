...
\RU{При помощи файлового менеджера FAR\FNURLFAR я нашел обе эти строки в файле SAPguilib.dll.}
\EN{With the help of the FAR file manager\FNURLFAR I found that both of these strings are stored in the SAPguilib.dll file.}
