...
(\RU{читайте}\EN{read} \RU{здесь}\EN{here}\footnote{\url{http://go.yurichev.com/17221}} 
\AndENRU 
...
\TT{atoi()}\footnote{standard C library function, converting number in string into number} is called. 
...
\RU{Да}\EN{Yes}. \RU{Функция} \TT{getenv\_s()}\footnote{\href{http://go.yurichev.com/17250}{MSDN}} 
...
\EN{Yes, and here is the only reference in function} \\
...
\EN{And here is how \IT{CNetwork} constructor sets a flag in the \IT{CNetwork} object according to the 5th argument \IT{and}
