...
\RU{Я нашел утилиту}\EN{I got} TYPEINFODUMP\footnote{\url{http://www.debuginfo.com/tools/typeinfodump.html}} \RU{для дампа содержимого \gls{PDB}-файлов во что-то более читаемое и grep-абельное}\EN{utility for converting \gls{PDB} files into something readable and grepable}.
