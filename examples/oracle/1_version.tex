...
\IFRU{Интересно что здесь этот элемент проходит также под номером $0x1f6$ (502-й), как и ссылка на строку 
\TT{X\$VERSION} в таблице \TT{kqftab}.}
{It's interesting that this element here is $0x1f6th$ (502nd), just as a pointer to \TT{X\$VERSION} string in 
\TT{kqftab} table.}
...
{We also see a pointer to \TT{kqvrow()} function. Something useful at last!}
