...
определенного столбца системной таблице к функции.}{\IT{Drain} probably mean \IT{connecting} specific 
...
\IT{OPN}, \IFRU{возможно}{probably}, \IT{open}, \IFRU{а}{and} \IT{DRN}, \IFRU{вероятно, означает}
{probably, meaning} \IT{drain}.
