...
к таблице \TT{X\$KSMLRU}.}{Indeed, with the \tracer help it is easy to see this function is called each 
...
\IFRU{Впрочем, это не обязательно полезное или желаемое поведение системы, но как эксперимент по поиску нужного кода, нам это подошло!}
