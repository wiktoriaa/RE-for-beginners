\subsection{\RU{Таблица \TT{X\$KSMLRU} в}\EN{\TT{X\$KSMLRU} table in} \oracle}
\myindex{\oracle}
...
\EN{It is probably not a very useful or desired system behavior, but as an experiment for locating a piece of code that we need, it perfectly suits our needs!}
