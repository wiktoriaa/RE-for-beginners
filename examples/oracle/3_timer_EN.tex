...
Indeed\EMDASH{}the value is the same we see in SQL*Plus and it is returned via the second argument.
...
and division of its result by 10 (\myref{sec:divisionbynine}))
...
divided by 10 (\myref{sec:divisionbynine}).
