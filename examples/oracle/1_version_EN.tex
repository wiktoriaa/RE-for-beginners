...
\oracle 11.2 is a huge program, its main module \TT{oracle.exe} contain approx. 124,000 functions. For comparison, the Windows 7 x86 kernel (ntoskrnl.exe) contains approx. 11,000 functions and the Linux 3.9.8 kernel (with default drivers compiled)\EMDASH{}31,000 functions.
...
By the way, often, while analysing \oracle's internals, you may ask yourself, why are the names of the functions and global variable so weird.
...
\TT{v} apparently stands for \IT{version} and \TT{t}\EMDASH{}\IT{type}? 
Hard to say.
