...
\TT{check1()} \RU{это имя которое я дал этой функции позже}\EN{is a function name I gave to it later}.
...
\RU{Мне даже, наверное, не нужно изучать остальные инструкции PowerPC: всё что делает эта функция это просто
вызывает}
