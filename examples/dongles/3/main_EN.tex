...
\lstinputlisting[style=customasm]{examples/dongles/3/1.lst}

(All label names in this example were given by me).

\TT{out\_port()} is referenced only in one function:

\lstinputlisting[style=customasm]{examples/dongles/3/2.lst}
...
\lstinputlisting[style=customasm]{examples/dongles/3/3.lst}
...
\lstinputlisting[style=customasm]{examples/dongles/3/4.lst}
...
\lstinputlisting[style=customasm]{examples/dongles/3/5.lst}
