...
\RU{Иногда я делал замену \glslink{dongle}{донглам} или \q{эмуляторы донглов} 
и здесь немного примеров, как это происходит.}
\EN{Occasionally I do software copy-protection \gls{dongle} replacements, or \q{dongle emulators} and here
