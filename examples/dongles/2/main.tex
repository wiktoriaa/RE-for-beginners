...
\myindex{thunk-\RU{функции}\EN{functions}}
...
\EN{If it is correct, 0xC or 0xB is to be written into the global variable \TT{ctl\_model}.}%
\RU{Если результат правилен, 0xC или 0xB будет записано в глобальную переменную \TT{ctl\_model}.}
