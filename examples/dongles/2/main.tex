\section{\IFRU{Пример}{Example} \#2: SCO OpenServer}
...
\IFRU{О том, что такое хэш-функция, было описано здесь}{A short description
...
\subsection{\IFRU{Дешифровка сообщений об ошибке}{Decrypting error messages}}

\IFRU{Кстати, мы также можем дешифровать все сообщения об ошибке}{By the way, we can also 
...
\IFRU{Здесь есть также и другие сообщения, с соответствующими ключами}{There are also 
