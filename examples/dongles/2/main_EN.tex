...
\lstinputlisting[style=customasm]{examples/dongles/2/1.lst}
...
\lstinputlisting[style=customasm]{examples/dongles/2/2.lst}

SSQ() can be called from at least 2 functions.

One of these is:

\lstinputlisting[style=customasm]{examples/dongles/2/check1.lst}
...
\lstinputlisting[style=customasm]{examples/dongles/2/4.lst}
...
\lstinputlisting[style=customasm]{examples/dongles/2/err_warn.lst}
...
\lstinputlisting[style=customasm]{examples/dongles/2/check2.lst}
...
\lstinputlisting[caption=Decryption function,style=customasm]{examples/dongles/2/decrypting_EN.lst}
