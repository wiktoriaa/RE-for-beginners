...
in MS-DOS and it will print this string}: ``EICAR-STANDARD-ANTIVIRUS-TEST-FILE!''
\footnote{\href{\RU{http://go.yurichev.com/17005}\EN{http://go.yurichev.com/17006}}{wikipedia}}.
% TODO \myref{} -> about .COM files
...
comments about the registers and stack after each instruction}.
