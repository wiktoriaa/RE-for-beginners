...
{What we see is that 3 numbers are pushing to stack in function \main and \TT{f(int,int,int)} 
is called then.}
...
in the same way as local variables accessed, but the difference in that these offsets are positive 
