...
\IFRU{если не считать новых FMA-инструкций}{if not to count new FMA-instruction}\footnote{\url{https://en.wikipedia.org/wiki/FMA_instruction_set}} \In SIMD.
...
{\TT{BX} instruction returns control to the address stored in the \LR register and, if it's necessary, 
