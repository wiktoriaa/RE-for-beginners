...
\IFRU{В процессоре ARM, как и во многих других ''чистых'' RISC-процессорах нет инструкции деления,
...
\IFRU{Пример деления 32-битного числа на 10 из книги}{Here is an example of 32-bit number division by 10 from the} ARM Cookbook (1994)\footnote{\href{http://yurichev.com/ref/ARM\%20Cookbook\%20(1994)/cook3.txt}{ARM Cookbook (1994)}}. \IFRU{На выходе и частное и остаток.}{Quotient and remainder on output.}
