...
\lstinputlisting[caption=MSVC,style=customasm]{\CURPATH/11_1_msvc_EN.asm}
...
\lstinputlisting[caption=\Optimizing MSVC,style=customasm]{\CURPATH/11_1_msvc_Ox.asm}
...
\lstinputlisting[caption=\NonOptimizing GCC 4.4.1,style=customasm]{\CURPATH/11_2_gcc.asm}
