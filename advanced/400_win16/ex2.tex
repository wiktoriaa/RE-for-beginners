...
\EN{as argument, which means that the pointer should be increased by $10$ bytes when the function exits}.
\RU{Это как}\EN{It is like} stdcall (\ref{sec:stdcall}), \EN{but the arguments are passed in 
