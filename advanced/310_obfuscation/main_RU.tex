...
\section{Исполняемый код}

\subsection{Вставка мусора}
...
\subsection{Замена инструкций на раздутые эквиваленты}
...
\subsection{Всегда исполняющийся/никогда не исполняющийся код}
...
\subsection{Сделать побольше путаницы}
...
\subsection{Использование косвенных указателей}
...
\section{Виртуальная машина / псевдо-код}
