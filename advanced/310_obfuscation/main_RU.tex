...
\sectionold{Исполняемый код}

\subsectionold{Вставка мусора}
...
\subsectionold{Замена инструкций на раздутые эквиваленты}
...
\subsectionold{Всегда исполняющийся/никогда не исполняющийся код}
...
\subsectionold{Сделать побольше путаницы}
...
\subsectionold{Использование косвенных указателей}
...
\sectionold{Виртуальная машина / псевдо-код}
