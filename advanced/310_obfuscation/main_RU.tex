...
\lstinputlisting[caption=obfuscated code,style=customasm]{\CURPATH/1_RU.asm}
...
\lstinputlisting[style=customasm]{\CURPATH/2_RU.asm}
...
\lstinputlisting[style=customasm]{\CURPATH/3_RU.asm}
