...
\lstinputlisting[caption=obfuscated code,style=customasm]{\CURPATH/1_EN.asm}
...
\lstinputlisting[style=customasm]{\CURPATH/2_EN.asm}
...
\lstinputlisting[style=customasm]{\CURPATH/3_EN.asm}
