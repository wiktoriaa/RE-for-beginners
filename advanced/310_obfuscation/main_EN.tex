...
\sectionold{Executable code}

\subsectionold{Inserting garbage}
...
\subsectionold{Replacing instructions with bloated equivalents}
...
\subsectionold{Always executed/never executed code}
...
\subsectionold{Making a lot of mess}
...
\subsectionold{Using indirect pointers}
...
\sectionold{Virtual machine / pseudo-code}
...
\sectionold{Other things to mention}
