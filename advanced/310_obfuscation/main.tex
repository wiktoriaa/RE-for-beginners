...
\EN{Programmers who aware of this, may try to hide them resulting inability to find the string in \IDA{} or any hex editor}.
...
\EN{The code looks weird, but as a simplest anti-reversing measure, it may be helpful.}
...
кодом-мусором для б\'{о}льшей путаницы}\EN{However, intermediate results produced by the real code 
