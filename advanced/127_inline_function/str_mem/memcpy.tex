...
\myparagraph{\RU{Короткие блоки}\EN{Short blocks}}
...
\lstinputlisting[caption=\RU{пример с memcpy()}\EN{memcpy() example},style=customc]{\CURPATH/str_mem/memcpy_7.c}

\lstinputlisting[caption=\Optimizing MSVC 2010,style=customasm]{\CURPATH/str_mem/memcpy_7_MSVC_2010_Ox.asm}

\lstinputlisting[caption=\Optimizing GCC 4.8.1,style=customasm]{\CURPATH/str_mem/memcpy_7_GCC_O3.s}
...
\myparagraph{\RU{Длинные блоки}\EN{Long blocks}}

\RU{Здесь компиляторы ведут себя по-разному.}\EN{The compilers behave differently in this case.}

\lstinputlisting[caption=\RU{пример с memcpy()}\EN{memcpy() example},style=customc]{\CURPATH/str_mem/memcpy.c}
...
\lstinputlisting[caption=\Optimizing MSVC 2010,style=customasm]{\CURPATH/str_mem/memcpy_128_MSVC_2010_Ox.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2010,style=customasm]{\CURPATH/str_mem/memcpy_123_MSVC_2010_Ox.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.8.1,style=customasm]{\CURPATH/str_mem/memcpy_GCC.s}
