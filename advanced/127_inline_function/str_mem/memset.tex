...
\lstinputlisting[caption=32 \RU{байта}\EN{bytes},style=customc]{\CURPATH/str_mem/memset_32.c}
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1 x64,style=customasm]{\CURPATH/str_mem/memset_32_GCC491_x64_O3.s}
...
\lstinputlisting[caption=67 \RU{байт}\EN{bytes},style=customc]{\CURPATH/str_mem/memset_67.c}
...
\lstinputlisting[caption=\Optimizing MSVC 2012 x64,style=customasm]{\CURPATH/str_mem/memset_67_MSVC2012_x64_Ox.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1 x64,style=customasm]{\CURPATH/str_mem/memset_67_GCC491_x64_O3.s}
