...
\RU{Современные оптимизирующие компиляторы самостоятельно выбирают ф-ции для вставки.
Но компилятор можно дополнительно принудить развернуть некоторую ф-цию, 
если маркировать её ключевым словом ``inline'' в её определении.}
...
it with the ``inline'' keyword in its declaration.}
