...
\lstinputlisting[caption=A simple example]{\CURPATH/1.c}
...
(Here the division is done by multiplication(\myref{sec:divisionbynine}).)

Yes, our small function \TT{celsius\_to\_fahrenheit()} was just placed before the \printf call.
