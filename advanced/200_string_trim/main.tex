...
\EN{The second part of for() (\TT{str\_len>0 \&\& (c=s[str\_len-1])}) is the so called ``short-circuit'' 
...
вычисляться.}
\EN{So if the first clause is false after evaluation, the second one will never be evaluated.}
