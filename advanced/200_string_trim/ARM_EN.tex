...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),style=customasm]{\CURPATH/Keil_ARM_O3_EN.s}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ThumbMode),numbers=left,style=customasm]{\CURPATH/Keil_thumb_O3_EN.s}
