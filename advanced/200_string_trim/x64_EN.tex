\sectionold{x64: \Optimizing MSVC 2013}

\lstinputlisting[caption=\Optimizing MSVC 2013 x64]{\CURPATH/MSVC2013_x64_Ox_EN.asm}
...
\lstinputlisting[caption=Inlined \strlen{} by MSVC 2013 x64]{\CURPATH/strlen_MSVC_EN.asm}

Try to write shorter if you want to initialize the counter at 0!
OK, let' try:

\lstinputlisting[caption=Our version of \strlen{}]{\CURPATH/my_strlen_EN.asm}
...
\sectionold{x64: \NonOptimizing GCC 4.9.1}

\lstinputlisting{\CURPATH/GCC491_x64_O0_EN.asm}
...
\sectionold{x64: \Optimizing GCC 4.9.1}
\label{string_trim_GCC_x64_O3}

\lstinputlisting{\CURPATH/GCC491_x64_O3_EN.asm}
...
Now the main loop is very short, which is good for modern \ac{CPU}s.
