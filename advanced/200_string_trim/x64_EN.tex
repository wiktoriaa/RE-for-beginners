...
\lstinputlisting[caption=\Optimizing MSVC 2013 x64,style=customasm]{\CURPATH/MSVC2013_x64_Ox_EN.asm}
...
\lstinputlisting[caption=Inlined \strlen{} by MSVC 2013 x64,style=customasm]{\CURPATH/strlen_MSVC_EN.asm}

Try to write shorter if you want to initialize the counter at 0!
OK, let' try:

\lstinputlisting[caption=Our version of \strlen{},style=customasm]{\CURPATH/my_strlen_EN.asm}
...
\lstinputlisting[style=customasm]{\CURPATH/GCC491_x64_O0_EN.asm}
...
\lstinputlisting[style=customasm]{\CURPATH/GCC491_x64_O3_EN.asm}
