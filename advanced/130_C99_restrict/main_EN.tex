...
\IT{restrict} in the C99 standard [\CNineNineStd 6.7.3/1]
...
\lstinputlisting[caption=GCC x64: f1()]{\CURPATH/f1_EN.asm}

\lstinputlisting[caption=GCC x64: f2()]{\CURPATH/f2_EN.asm}
...
so when it was not possible to set \IT{restrict} in C, Fortran can generate faster code in these cases.
