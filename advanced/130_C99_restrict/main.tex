...
\EN{is a promise, given by programmer to the compiler that the function arguments marked by this keyword will always
point to different memory locations and will never intersect.}
...
\RU{Очевидно, второй вариант будет работать быстрее.}\EN{Obviously, the second example will work faster.}
...
\EN{This will be on the programmer's conscience, and the results may be incorrect.}
...
certainly, the speed boost will not be significant.}
