\sectionold{Computing arithmetic mean}
...
\subsectionold{Using va\_arg macro}
...
\subsubsectionold{\IT{cdecl} calling conventions}
...
\subsubsectionold{Register-based calling conventions}
...
\subsectionold{Using pointer to the first function argument}
