...
\lstinputlisting[caption=\Optimizing GCC 4.8.1 -fno-inline-small-functions,style=customasm]{\CURPATH/STL/list/GCC_EN.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2012 /Fa2.asm /GS- /Ob1,style=customasm]{\CURPATH/STL/list/MSVC_EN.asm}
