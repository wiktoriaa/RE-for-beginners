...
\lstinputlisting[caption=MSVC 2012 /GS- /Ob1,style=customasm]{\CURPATH/STL/vector/MSVC.asm}
...
\lstinputlisting[caption=GCC 4.8.1 -fno-inline-small-functions -O1,style=customasm]{\CURPATH/STL/vector/GCC.asm}
