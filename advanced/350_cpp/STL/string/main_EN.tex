...
\myparagraph{A more complex example}

\lstinputlisting[style=customc]{\CURPATH/STL/string/3.cpp}

\lstinputlisting[caption=MSVC 2012,style=customasm]{\CURPATH/STL/string/3_MSVC_EN.asm}
...
\lstinputlisting[caption=GCC 4.8.1,style=customasm]{\CURPATH/STL/string/3_GCC_EN.s}
...
\lstinputlisting[caption=MSVC 2012: here is how a global variable is constructed and also its destructor is registered,style=customasm]{\CURPATH/STL/string/5_MSVC_p2.asm}

\lstinputlisting[caption=MSVC 2012: here a global variable is used in \main,style=customasm]{\CURPATH/STL/string/5_MSVC_p1.asm}

\lstinputlisting[caption=MSVC 2012: this destructor function is called before exit,style=customasm]{\CURPATH/STL/string/5_MSVC_p3.asm}
...
\lstinputlisting[caption=GCC 4.8.1,style=customasm]{\CURPATH/STL/string/5_GCC.s}
