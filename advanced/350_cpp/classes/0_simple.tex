...
\myindex{\RU{ООП!Полиморфизм}\EN{OOP!Polymorphism}}
...
\myindex{\RU{Компоновщик}\EN{Linker}}
...
\RU{Из стандарта \Cpp мы знаем}\EN{From the \Cpp standard} (C++11 12.1) 
...
\Reg{9} (\SysVABI)\RU{, а указатель на \ITthis через первый (\RDI) что мы здесь и видим}\EN{ registers,
