\subsubsection{\RU{Множественное наследование}\EN{Multiple inheritance}}
...
\lstinputlisting[caption=\Optimizing MSVC 2008 /Ob0,style=customasm]{\CURPATH/classes/classes3_1.asm}

\lstinputlisting[caption=\Optimizing MSVC 2008 /Ob0,style=customasm]{\CURPATH/classes/classes3_2.asm}

\lstinputlisting[caption=\Optimizing MSVC 2008 /Ob0,style=customasm]{\CURPATH/classes/classes3_3.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2008 /Ob0,style=customasm]{\CURPATH/classes/classes3_4.asm}

\lstinputlisting[caption=\Optimizing MSVC 2008 /Ob0,style=customasm]{\CURPATH/classes/classes3_5.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2008 /Ob0,style=customasm]{\CURPATH/classes/classes3_6.asm}
...
\RU{Так, метод \TT{solid\_object::get\_density()} будет полагать что работает с обычным классом \\
