...
\footnote{\RU{Об указателях на функции читайте больше в соответствующем разделе}\EN{You can read more about pointers to functions in the relevant section}:(\ref{sec:pointerstofunctions})}
