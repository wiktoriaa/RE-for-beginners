\sectionold{Null pointers}

\subsectionold{``Null pointer assignment'' error of MS-DOS era}
...
\begin{figure}[H]
	\centering
	\myincludegraphics{advanced/450_more_ptrs/tc30.png}
...
\subsectionold{Why would anyone write at address 0?}
...
\subsectionold{Null pointer to function}
