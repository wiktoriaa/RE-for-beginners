...
\RU{Всё что нам нужно знать это то что ``0'' минус ``0''\EMDASH{}это 0, а ``9'' минус ``0'' это 9, \etc{}.}
...
\EN{If the ``minus'' sign was encountered at the string start, the NEG instruction is to be executed at the end.}
...
% FIXME1: security researchers deals often with behaviour of handling of incorrect data,
% so try enter non-digits and see what happens. explain, why, etc.
