...
\lstinputlisting[caption=\Optimizing MSVC 2013 x64,style=customasm]{\CURPATH/atoi.asm.MSVC2013.x64.Ox_EN}
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1 x64,style=customasm]{\CURPATH/atoi.s.GCC491.O3.x64_EN}

\subsubsection{\OptimizingKeilVI (\ARMMode)}

\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),style=customasm]{\CURPATH/atoi.s.ARM.O3_EN}

\subsubsection{\OptimizingKeilVI (\ThumbMode)}

\lstinputlisting[caption=\OptimizingKeilVI (\ThumbMode),style=customasm]{\CURPATH/atoi.s.thumb.O3_EN}
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1 ARM64,style=customasm]{\CURPATH/atoi.s.GCC49.ARM64.O3_EN}
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1 x64,style=customasm]{\CURPATH/atoi2.s.GCC491.O3.x64_EN}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),numbers=left,style=customasm]{\CURPATH/atoi2.s.ARM.O3_EN}
