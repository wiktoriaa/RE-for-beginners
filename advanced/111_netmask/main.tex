...
\hline
\HeaderColor \EN{Mask}\RU{Маска} & 
\HeaderColor \EN{Hosts}\RU{Хосты} & 
\HeaderColor \EN{Usable}\RU{Свободно} &
\HeaderColor \EN{Netmask}\RU{Сетевая маска} &
\HeaderColor \EN{Hex mask}\RU{В шестнадцатеричном виде} &
\HeaderColor \\
\hline
