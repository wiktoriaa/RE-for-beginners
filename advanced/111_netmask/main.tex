...
\EN{At line 22 we see the most important \ANDIns\EMDASH{}here the network address is calculated.}
\RU{На строке 22 мы видим самую важную инструкцию \ANDIns\EMDASH{}так вычисляется адрес сети.}
...
\RU{Я также сделал отдельную функцию}\EN{I also wrote a separate function} \TT{set\_bit()}. 
