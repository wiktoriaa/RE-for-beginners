...
\lstinputlisting[caption=\Optimizing MSVC 2012 /Ob0,numbers=left,style=customasm]{\CURPATH/calc_network_address_MSVC_2012_Ox.asm}
...
\lstinputlisting[caption=\NonOptimizing MSVC 2012,style=customasm]{\CURPATH/form_IP_MSVC_2012_EN.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2012 /Ob0,style=customasm]{\CURPATH/form_IP_MSVC_2012_Ox_EN.asm}
...
\lstinputlisting[caption=\NonOptimizing MSVC 2012,style=customasm]{\CURPATH/print_as_IP_MSVC_2012_EN.asm}

\Optimizing MSVC 2012 does almost the same, but without unnecessary reloading of the input value:

\lstinputlisting[caption=\Optimizing MSVC 2012 /Ob0,style=customasm]{\CURPATH/print_as_IP_MSVC_2012_Ox.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2012 /Ob0,style=customasm]{\CURPATH/form_netmask_MSVC_2012_Ox.asm}
