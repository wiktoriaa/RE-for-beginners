include(`commons.m4') add     [ebp-31F7Bh], cl
 ...
 db 0FFh
 db 0FFh
 mov     word ptr [ebp-214h], cs ; <- _EN(`disassembler finally found right track here')_RU(`дизассемблер наконец нашел здесь правильный старт')
