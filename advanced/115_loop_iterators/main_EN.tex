...
\lstinputlisting[caption=\Optimizing MSVC 2013 x64,style=customasm]{\CURPATH/MSVC_2013_x64_Ox_EN.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.9 x64,style=customasm]{\CURPATH/GCC491_x64_O3_EN.asm}
...
\lstinputlisting[caption=\Optimizing GCC (Linaro) 4.9 ARM64,label=GCC_no_number_sign,style=customasm]{\CURPATH/ARM64_GCC_49_O3_EN.s}

% FIXME1 -> post-increment

GCC 4.4.5 for MIPS does the same:

\lstinputlisting[caption=\Optimizing GCC 4.4.5 for MIPS (IDA),style=customasm]{\CURPATH/MIPS_O3_IDA_EN.lst}
...
\lstinputlisting[caption=\Optimizing Intel C++ 2011 x64,style=customasm]{\CURPATH/intel_2011_x64_Ox.asm}
