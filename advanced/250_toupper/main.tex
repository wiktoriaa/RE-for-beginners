\section{\RU{Функция toupper()}\EN{toupper() function}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{\CURPATH/ascii.png}
\caption{\EN{7-bit \ac{ASCII} table in Emacs}\RU{7-битная таблица \ac{ASCII} в Emacs}}
\end{figure}

\subsection{x64}

\subsubsection{\EN{Two comparison operations}\RU{Две операции сравнения}}
...
\subsubsection{\EN{One comparison operation}\RU{Одна операция сравнения}}
...
\subsubsection{GCC \ForENRU ARM64}
