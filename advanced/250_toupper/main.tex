\chapterold{\RU{Функция toupper()}\EN{toupper() function}}
...
\begin{figure}[H]
\centering
\myincludegraphics{\CURPATH/ascii.png}
\caption{\EN{7-bit \ac{ASCII} table in Emacs}\RU{7-битная таблица \ac{ASCII} в Emacs}}
\end{figure}

\sectionold{x64}

\subsectionold{\EN{Two comparison operations}\RU{Две операции сравнения}}
...
\subsectionold{\EN{One comparison operation}\RU{Одна операция сравнения}}
...
\subsectionold{GCC \ForENRU ARM64}
