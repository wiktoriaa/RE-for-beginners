...
\lstinputlisting[caption=MSVC 2012,style=customasm]{advanced/700_openmp/MSVC_loop.asm}
...
\lstinputlisting[caption=MSVC 2012,style=customasm]{advanced/700_openmp/MSVC_1.asm}
...
\lstinputlisting[caption=MSVC 2012,style=customasm]{advanced/700_openmp/MSVC_2.asm}
...
\begin{lstlisting}[caption=GCC 4.8.1,style=customasm]
...
\lstinputlisting[caption=GCC 4.8.1,style=customasm]{advanced/700_openmp/GCC_1.asm}
...
\lstinputlisting[caption=GCC 4.8.1,style=customasm]{advanced/700_openmp/GCC_2.asm}
