...
A popular way\footnote{This way is also controversial, because it leads to hard-to-read code} to convert a zero value into 1 (or boolean \IT{true}) and non-zero value into 0 (or boolean \IT{false}) is \IT{!!statement}:
