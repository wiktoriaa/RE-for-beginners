% TODO TikZ
\chapter{Packing 12-bit values into array using bit operations (x64, ARM/ARM64, MIPS)}
...
\section{Optimizing GCC 4.8.2 for x86-64}
...
\section{Optimizing Keil 5.05 (Thumb mode)}
...
\section{Optimizing Keil 5.05 (ARM mode)}
...
\section{(32-bit ARM) Comparison of code density in Thumb and ARM modes}
...
\section{Optimizing GCC 4.9.3 for ARM64}
...
\section{Optimizing GCC 4.4.5 for MIPS}
...
\section{Difference from the real FAT12}
