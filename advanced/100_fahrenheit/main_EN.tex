...
\lstinputlisting[caption=\Optimizing MSVC 2012 x86,style=customasm]{\CURPATH/i_MSVC_2012_Ox_x86_EN.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2010 x86,style=customasm]{\CURPATH/f_MSVC_2010_x86_Ox_EN.asm}

\dots but MSVC  2012 uses \ac{SIMD} instructions instead:

\lstinputlisting[caption=\Optimizing MSVC 2010 x86,style=customasm]{\CURPATH/f_MSVC_2012_x86_Ox_EN.asm}
