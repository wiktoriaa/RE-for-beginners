...
[\ARMCookBook 3.3 Division by a Constant].
...
\TT{ASR} означает \IT{Arithmetic Shift Right}, \TT{LSR}\EMDASH\IT{Logical Shift Right}.
...
\EMDASH\TT{ASRS} (арифметический сдвиг вправо).

\subsectionold{\NonOptimizing Xcode 4.6.3 (LLVM) и Keil 6/2013}
