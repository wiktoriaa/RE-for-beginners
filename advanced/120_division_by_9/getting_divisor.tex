...
\EN{The numbers are larger than 32-bit, so I used} Wolfram Mathematica \RU{для удобства}\EN{for convenience}:
...
\RU{Так что искомый делитель это}\EN{So the divisor from the code I used as example is} 17.
...
\index{Wolfram Mathematica}
\RU{Снова использую}
\EN{And again I used} Wolfram Mathematica:
