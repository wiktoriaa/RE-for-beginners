...
\index{FORTRAN}
\EN{It's very hard to say why one should use it, I know probably only one practical application
...
\EN{Here is the stack fragment I copypasted from \olly's stack window (with my comments):}
...
\RU{Трюк этот все-таки слишком хакерский и сомнительный, вряд ли кто-то должен его использовать в своем коде,
