\chapterold{Negative array indices}
...
\sectionold{Addressing string from the end}
...
\sectionold{Adressing some kind of block from the end}
...
\sectionold{Arrays started at 1}
