...
\lstdefinestyle{customasm}{
  ...
  %otherkeywords={j,jr,li,pushl,movl,andl,subl,rax,rbx,rcx,rdx,rsi,rdi,rbp,rsp,rip,stp,adrp,ldp,retn,lui,addiu,sw,lw,jalr,move,stmfd,adr,ldmfd,dcb,movt,movw,movt.w,blx,STMFD,MOVT,LDMFD,ADR,MOVW,MOVT.W,BLX,la,leal,DWORD,PTR,
  %r8d,r9d},
  showstringspaces=false,
  %backgroundcolor=\color{bg},
  %keywordstyle=\color{col3},
