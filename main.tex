...
\newcommand{\VERSION}{0.9} % version WHICH IS PREPARED NOW. 0.2 mean 0.19999(9)
...
\IFRU{Англоязычная версия текста также доступна по ссылке}{Russian language version of this text is also accessible at} \url{http://yurichev.com/RE-book.html}
\end{center}
\end{titlepage}
...
\IFRU{Денис Юричев ~--- опытный reverse engineer и тренер, свободный для найма. С его резюме можно ознакомиться \href{http://yurichev.com/Dennis_Yurichev.pdf}{здесь}.}{Dennis Yurichev is experienced reverse engineering and trainer, available for hire. His CV is available \href{http://yurichev.com/Dennis_Yurichev.pdf}{here}.}

\chapter{\IFRU{Благодарности}{Thanks}}

\IFRU{Андрей ''herm1t'' Баранович, Слава ''Avid'' Казаков, Станислав ''Beaver'' Бобрицкий, Александр Лысенко, Александр ''Lstar'' Черненький.}{Andrey ''herm1t'' Baranovich, Slava ''Avid'' Kazakov, Stanislav ''Beaver'' Bobrytskyy, Alexander Lysenko, Alexander ''Lstar'' Chernenkiy.}
...
\include{classes/classes_1_inheritance}

\include{classes/classes_2_encapsulation}

\include{classes/classes_3_mutiple}

\include{classes/classes_4_virtual}
