...
\lstset{
    ...
    %backgroundcolor=\color{light-gray}, % FIXME: if you want to enable this, solve problem with annyoing white stripes... http://stackoverflow.com/questions/3374151/stripes-in-background-color-drawn-by-listings-package
    basicstyle=\LstStyle,
    breaklines=true,
