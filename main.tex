...
\ifx\LITE\undefined
\shorttoc{\RU{Краткое оглавление}\EN{Abridged contents}\SP{Spanish text}\PTBRph{}\SPph{}}{-1} % Only sections
\fi
\tableofcontents
\cleardoublepage
...
\clearpage
\phantomsection
\addcontentsline{toc}{chapter}{\RU{Глоссарий}\EN{Glossary}\PTBRph{}\SPph{}}
\printglossaries
...
\clearpage
\phantomsection
\addcontentsline{toc}{chapter}{\RU{Библиография}\EN{Bibliography}\PTBRph{}\SPph{}}
\printbibliography
