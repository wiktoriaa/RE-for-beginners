...
Caller also should return back value of the \ESP to its initial state after callee function exit.}
...
but it's easy to illustrate an important difference between \IT{cdecl} and \IT{stdcall} with the help of it.
...
{It's not a standardized way, so, various compilers may do it differently.
