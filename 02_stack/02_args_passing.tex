...
{One could implement any other method without using stack at all.}
...
{For example, it is possible to allocate a space for arguments in heap, fill it and pass to a function 
via pointer to this pack in the \EAX register. And this will work}
