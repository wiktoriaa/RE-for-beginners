...
{Callee{\footnote{Function being called}} functions get their arguments via the stack ponter.}
...
{By the way, callee function has not any information, how many arguments were passed.}
