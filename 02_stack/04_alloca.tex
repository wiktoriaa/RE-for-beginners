...
\footnote{\IFRU{Это потому что alloca() это не сколько функция, сколько т.е. compiler intrinsic}{It is because
...
\IFRU{Обратите внимание что, например}{Please note: for example}, \TT{movl \$3, 20(\%esp)} 
