...
\footnote{\IFRU{Это потому что alloca() это не сколько функция, сколько т.е. \gls{compiler intrinsic}}
{It is because alloca() is rather \gls{compiler intrinsic} than usual function}}.
