...
be triggered.
Conditional jump will be triggered only if \TT{0x40000000} bit is absent in the \TT{dwDesiredAccess} variable ~--- 
then \ANDIns result will be $0$, \ZF flag will be set and conditional jump is to be triggered.}
