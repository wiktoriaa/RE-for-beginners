...
{That's shorter.
It is worth noting the compiler works with the \EAX register part via the \AH register ~--- 
...
{16-bit CPU 8086 accumulator was named \AX and consisted of two 8-bit halves ~--- 
