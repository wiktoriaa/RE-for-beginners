...
\lstinputlisting{14_bitfields/set_reset_msvc.asm}
...
\lstinputlisting{14_bitfields/set_reset_msvc_Ox.asm}

\IFRU{Попробуем GCC 4.4.1 без оптимизации:}{Let's try GCC 4.4.1 without optimization:}

\lstinputlisting{14_bitfields/set_reset_gcc.asm}
...
\lstinputlisting{14_bitfields/set_reset_gcc_O3.asm}
...
\lstinputlisting{14_bitfields/set_reset_gcc_O3_regparm3.asm}
