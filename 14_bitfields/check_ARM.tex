...
{We can ``spot'' visually this code fragment by the fact that the \TT{lookup\_fast()} will be executed
...
\IFRU{Макрос }{}\TT{O\_CREAT} \IFRU{здесь так же равен \TT{0x40}.}{macro is equals to \TT{0x40} here too.}
