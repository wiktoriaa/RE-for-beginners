...
\input{01_helloworld/main}
\input{02_stack/main}
\input{03_printf/main}
\input{04_scanf/main}
\input{05_passing_arguments/main}
\input{06_return_results/main}
\input{061_pointers/main}
\input{07_jcc/main}
\input{08_switch/main}
\input{09_loops/main}
\input{10_strlen/main}
\input{11_division_by_9/main}
\input{12_FPU/main}
\input{13_arrays/main}
\input{14_bitfields/main}
\input{15_structs/main}
\input{16_classes/main}
\input{16_classes/1_inheritance}
\input{16_classes/2_encapsulation}
\input{16_classes/3_mutiple}
\input{16_classes/4_virtual}
\input{17_unions/main}
\input{18_pointers_to_functions/main}
\input{19_SIMD/main}
\input{20_x64/main}
\input{21_C99_restrict/main}
\input{22_inline_function/main}
