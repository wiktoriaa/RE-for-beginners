...
\INS{OR reg, 0xFFFFFFFF} sets all bits to 1, hence, no matter what was in register before, it will be set to $-1$.
...
\INS{XOR reg, reg}, no matter what was in registers beforehand, resets all bits, and also acts like \INS{MOV reg, 0}.
