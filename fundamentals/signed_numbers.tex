...
If we represent them both as signed, the first one will be $-2$, and it will be smaller than the second ($2$). 
...
\EN{The addition is needed because zero is present in the middle.}
