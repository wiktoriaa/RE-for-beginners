...
Probably because of this fact, C/C++ standard tells that \IT{char} has to have \IT{at least} 8 bits.
...
Probably this was some kind of toy-level virtualization (\myref{8086_memory_model})?
...
Number increasing from 0, like: 0, 1, 2, 3\dots---a good chance this is loop counter and/or array index.
