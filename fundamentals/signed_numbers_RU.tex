...
\hline
\cellcolor{blue!25} двоичное & \cellcolor{blue!25} шестнадцатеричное & \cellcolor{blue!25} беззнаковое & \cellcolor{blue!25} знаковое (дополнительный код) \\
\hline
...
\item Знаковые типы в \CCpp:
  ...
  \begin{itemize}
    ...
    \item \Tint (-2,147,483,648..2,147,483,647 (-~2.15..~2.15Gb) или \TT{0x80000000..0x7FFFFFFF}),
...
\item У знаковых чисел знак определяется самым старшим битом: 1 означает \q{минус}, 0 означает \q{плюс}.
