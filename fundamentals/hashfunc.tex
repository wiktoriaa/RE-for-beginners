...
\chapterold{\HashFuncChapterName}
\label{hash_func}
...
\sectionold{Как работает односторонняя функция?}
...
\sectionold{How do one-way functions work?}
...
\sectionold{?`C\'omo trabajan las funciones de una v\'ia?}
