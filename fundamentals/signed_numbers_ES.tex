...
\hline
\cellcolor{blue!25} binario & \cellcolor{blue!25} hexadecimal & \cellcolor{blue!25} sin signo & \cellcolor{blue!25} con signo (complemento a dos) \\
\hline
...
\item Tipos con signo en \CCpp:
  ...
  \begin{itemize}
    ...
    \item \Tint (-2,147,483,648..2,147,483,647 (-~2.15..~2.15Gb) \ESph{} \TT{0x80000000..0x7FFFFFFF}),
