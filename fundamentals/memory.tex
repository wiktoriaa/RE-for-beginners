...
\EN{Buffer overflows occurring here usually overwriting variable or buffer residing next in memory.}
...
\RU{Выделение происходит при помощи вызова}\EN{Allocation occurring by calling} 
...
method: block size may be set at runtime}.
