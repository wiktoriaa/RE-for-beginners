\part*{\RU{Список принятых сокращений}\EN{Acronyms used}\ESph{}\PTBRph{}}
\addcontentsline{toc}{part}{\RU{Список принятых сокращений}\EN{Acronyms used}\ESph{}\PTBRph{}}
\begin{acronym}
\RU{
...
\acro{RA}{\RU{Адрес возврата}\EN{Return Address}\PTBRph{}\ESph{}}
...
\acro{AKA}{Also Known As\RU{ (Также известный как)}\ESph{}\PTBRph{}}
...
\acro{ELF}{\RU{Формат исполняемых файлов, использующийся в Linux и некоторых других *NIX}
	\EN{Executable file format widely used in *NIX systems including Linux}\ESph{}\PTBRph{}}
...
\acro{PID}{\RU{ID программы/процесса}\EN{Program/process ID}\ESph{}\PTBRph{}}
