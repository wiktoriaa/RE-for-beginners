...
\FR{Format de fichier exécutable courament utilisé sur les systèmes *NIX, Linux inclus}}
...
\FR{chaîne ASCII terminée par un octet nuk (à zéro)}\ESph{}\PTBRph{}\PLph{}\ITAph{}\DEph{}\NLph{})}
