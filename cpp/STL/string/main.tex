...
\IFRU{Об этом можно и забыть: до тех пока там не появится строка короче 16-и символов, тогда процесс упадет}
{One may forget about it: until longer string will be appeared there, then a process will crash}.
