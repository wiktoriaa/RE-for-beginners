...
_main	PROC
	cmp	DWORD PTR ?s@@3V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@A+20, 16 ; 00000010H
...
??__Fs@@YAXXZ PROC					; `dynamic atexit destructor for 's'', COMDAT
	...
	pop	esi
$LN23@dynamic:
	mov	DWORD PTR ?s@@3V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@A+20, 15 ; 0000000fH
