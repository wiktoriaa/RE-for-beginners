...
A: \EN{Unless you are an OS developer, you probably don't need to code in assembly -  
modern compilers are much better at performing optimizations much better than humans}
...
\EN{Also, modern \ac{CPUs} are very complex devices and assembly knowledge doesn't really help one to understand their internals.}
...
\\
Q: \RU{Как можно найти работу reverse engineer-а}\EN{How does one get a job inreverse engineering}? \\
