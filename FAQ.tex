...
A: \EN{Unless you are OS developer, you probably don't need to write in assembly: 
...
\\
\ifx\LITE\undefined
Q: \RU{Ваша книга слишком большая! Нет ли чего покороче?}\EN{Your book is so huge! Is there anything shorter?}\\
A: \RU{Имеется сокращенная lite-версия}\EN{There is shortened lite version}: \url{http://beginners.re/\#lite}.\\
\\
\fi
...
\EN{Someone may also want to build their own version of book, read \href{\HACKINGMdURL}{here} about it.}
...
\\
Q: \RU{Как можно найти работу reverse engineer-а}\EN{How would one find a reverse engineering job}? \\
