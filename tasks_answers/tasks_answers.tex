...
\href{http://yurichev.com/RE-tasks-answers/middle/1/tasks_2_1.c}{\IFRU{Исходник на Си}{C source code}}.

\subsection{\Task 2.2}

Подсказка: проще всего конечно же искать по таблицам.

\href{http://yurichev.com/RE-tasks-answers/middle/2/gost.c}
{\IFRU{Исходник на Си с комментариями}{Commented C source code}}.

\subsection{\Task 2.3}

\href{http://yurichev.com/RE-tasks-answers/middle/3/entropy.c}
{\IFRU{Исходник на Си с комментариями}{Commented C source code}}.

\subsection{\Task 2.4}

\href{http://yurichev.com/RE-tasks-answers/middle/4/}
