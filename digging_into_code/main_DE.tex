...
ist. Der Autor hat schließlich eine Ahnung gehabt, das eine Funktion genannt \IT{CsDecomprLZC} die Dekompression der Netzwerkpakete übernahm.
...
\section{Communication with outer world (function level)} % <-- übersetzen
...
\section{Other things}  % <-- übersetzen

\subsection{General idea}  % <-- übersetzen
...
\subsection{Order of functions in binary code}  % <-- übersetzen
...
\subsection{Tiny functions}  % <-- übersetzen
