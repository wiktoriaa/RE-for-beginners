\chapter{Связь с внешним миром (win32)}
...
\section{Часто используемые функции Windows API}
...
\section{Расширение триального периода}
