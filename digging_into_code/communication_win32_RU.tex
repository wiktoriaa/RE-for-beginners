\chapterold{Связь с внешним миром (win32)}
...
\sectionold{Часто используемые функции Windows API}
...
\sectionold{Расширение триального периода}
