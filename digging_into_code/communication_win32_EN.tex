\chapter{Communication with the outer world (win32)}
...
\section{Often used functions in the Windows API}
...
\section{Extending trial period}
...
\section{Removing nag dialog box}
...
\section{tracer: Intercepting all functions in specific module}
\myindex{tracer}
