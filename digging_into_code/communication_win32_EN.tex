\chapterold{Communication with the outer world (win32)}
...
\sectionold{Often used functions in the Windows API}
...
\sectionold{Extending trial period}
...
\sectionold{Removing nag dialog box}
...
\sectionold{tracer: Intercepting all functions in specific module}
\myindex{tracer}
