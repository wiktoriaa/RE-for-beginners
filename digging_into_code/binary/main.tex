...
\sectionold{\RU{Некоторые паттерны в бинарных файлах}\EN{Some binary file patterns}}
...
\clearpage
\subsectionold{\EN{Arrays}\RU{Массивы}}
...
\clearpage
\subsectionold{\EN{Sparse files}\RU{Разреженные файлы}}
...
\clearpage
\subsectionold{\EN{Compressed file}\RU{Сжатый файл}}
...
\clearpage
\subsectionold{\EN{32-bit x86 executable code}\RU{32-битный x86 исполняемый код}}
...
\clearpage
\subsectionold{\EN{BMP graphics files}\RU{Графические BMP-файлы}}
...
\begin{figure}[H]
\centering
\myincludegraphics{digging_into_code/binary/bmp.png}
