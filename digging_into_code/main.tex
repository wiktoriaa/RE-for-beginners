...
(it is an open-source SAP project)\footnote{More about it in relevant section~(\ref{sec:SAPGUI})}.}
...
\EN{The old-school techniques, nevertheless, areinteresting to know}}
