\partold{\RU{Поиск в коде того что нужно}\EN{Finding important/interesting stuff in the code}}
...
\chapterold{\RU{Прочее}\EN{Other things}}

\sectionold{\EN{General idea}\RU{Общая идея}}
