...
sie sind zusammen-gesetzt aus verändernden Bits. % <-- Findest vielleicht noch ne besere bezeichnung
...
wir können auch sehen wo der Puffer mit den Inhalten der MIDI Datei liegt und was/wie aus diesem
