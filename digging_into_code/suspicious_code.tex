...
\EN{One exception to this observation worth noting is the ``canary'' (\myref{subsec:BO_protection}). 
...
Подобные инструкции отмечены как (M) в списке инструкций в приложении: \myref{sec:x86_instructions}.
