\chapterold{\RU{Подозрительные паттерны кода}\EN{Suspicious code patterns}}

\sectionold{\RU{Инструкции XOR}\EN{XOR instructions}}
...
\sectionold{\RU{Вручную написанный код на ассемблере}\EN{Hand-written assembly code}}
