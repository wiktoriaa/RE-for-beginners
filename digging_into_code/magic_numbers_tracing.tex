...
{Often, main goal is to get to know, how some value was read from file, or received via network, being used. 
Often, manual tracing of some value is very labouring task. One of the simple methods (however, not 100\% reliable) 
