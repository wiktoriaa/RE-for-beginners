...
\EN{This resembling X-ray computed tomography is some sense: radiocontrast agent is injected into patient's blood,
which is used for improving visibility of internal structures in X-rays. For example, it is well known how blood of healthy human
percolates in kidneys and if agent is in blood, it will be easily seen on tomography, how blood is percolating,
...
\newcommand{\DOSBOXURL}{\url{http://go.yurichev.com/17222}}
