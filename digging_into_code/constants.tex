...
\EN{That may help to distinguish some signal from a signal where all bits are turned on (1111 \dots) or off (0000 \dots).}
...
\EN{If you find these four constants used in the code in a row, it is highly probable that this function is related to MD5.}
...
\section{\EN{Magic numbers}\RU{Магические числа}}

\newcommand{\FNURLMAGIC}{\footnote{\href{http://go.yurichev.com/17112}{wikipedia}}}

\RU{Немало форматов файлов определяет стандартный заголовок файла где используются \IT{магическое число} (magic number)\FNURLMAGIC{}, один или даже несколько.}
...
\ifdefined\ENGLISH
Often, one may encounter number like \TT{0x19861115}, which is clearly looks like a date (year 1986, 11th month (November), 15th day).
This may be someone's birthday (a programmer, his/her relative, child), or some other important date.
The date may also be written in a reverse order, like \TT{0x15111986}.
...
\ifdefined\RUSSIAN
Часто, можно встретить число вроде \TT{0x19861115}, которое явно выглядит как дата (1986-й год, 11-й месяц (ноябрь), 15-й день).
Это может быть чей-то день рождения (программиста, его/её родственника, ребенка), либо какая-то другая важная дата.
Дата может быть записана и в другом порядке, например \TT{0x15111986}.
