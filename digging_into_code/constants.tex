...
it is very high probability this function is related to MD5.}
...
\IT{Something} received DHCP packet should check \IT{magic cookie}, comparing it with the constant.}
