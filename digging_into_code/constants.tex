\chapter{\IFRU{Константы}{Constants}}

\IFRU{Люди, включая программистов, часто используют круглые числа вроде}
{Humans, including programmers, often use round numbers like} 10, 100, 1000, 
\IFRU{в т.ч. и в коде}{as well as in the code}.

\IFRU{Практикующие реверсеры, обычно, хорошо знают их в шестнадцатеричном представлении}
{Practicing reverse engineer, usually know them well in hexadecimal representation}:
...
\section{\IFRU{Поиск констант}{Constant searching}}
