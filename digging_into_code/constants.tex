...
\newcommand{\FNURLMAGIC}{\footnote{\url{http://go.yurichev.com/17112}}}
...
\EN{For example, all Win32 and MS-DOS executables are started with two characters} ``MZ''\footnote{\url{http://go.yurichev.com/17113}}.
