...
usually, this macro leaves source file name, line number and condition in code.}
...
code is here. Also by file names it's possible to recognize some well-known open-source library.}

\lstinputlisting[caption=\IFRU{Пример информативных вызовов assert()}{Example of informative assert() calls}]{digging_into_code/assert_examples.lst}
...
{It's advisable to ``google'' both conditions and file names, that may lead us to open-source library.
