...
\EN{It is advisable to ``google'' both the conditions and file names, which can lead us to an open-source library.
For example, if we ``google'' ``sp->lzw\_nbits <= BITS\_MAX'', this predictably 
