% FIXME comparison!
\sectionold{\RU{Сравнение \q{снимков} памяти}\EN{Memory \q{snapshots} comparing}}
...
\subsectionold{\RU{Реестр Windows}\EN{Windows registry}}
...
\subsectionold{\EN{Blink-comparator}\RU{Блинк-компаратор}}
