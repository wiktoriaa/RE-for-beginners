...
{The technique of simple two memory snapshots comparing in order to see changes, was often used to hack
...
enthusiastic gamers knew, which byte must be written (using BASIC instruction \IT{POKE}\footnote{BASIC language instruction writting byte on specific address}) to which address in
