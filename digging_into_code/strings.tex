\chapterold{\RU{Строки}\EN{Strings}}
\label{sec:digging_strings}

\EN{\input{digging_into_code/strings/main_EN}}
\RU{\input{digging_into_code/strings/main_RU}}

\sectionold{\RU{Сообщения об ошибках и отладочные сообщения}\EN{Error/debug messages}}
...
\sectionold{\EN{Suspicious magic strings}\RU{Подозрительные магические строки}}
