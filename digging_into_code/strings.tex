\chapter{\IFRU{Строки}{Strings}}
\label{sec:digging_strings}

\input{digging_into_code/strings/main}

\section{\IFRU{Сообщения об ошибках и отладочные сообщения}{Error/debug messages}}
...
Funny cases sometimes happen}\footnote{\url{http://blog.yurichev.com/node/32}}.
...
More about it}\footnote{\url{http://blog.yurichev.com/node/43}}.
...
\IFRU{Один из примеров шифрования сообщений об ошибке, здесь}{One example of encrypted error messages 
