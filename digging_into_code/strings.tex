...
\EN{Indeed, the ``userRpmNatDebugRpm26525557'' string is present in the firmware.}
...
\EN{More precise, this method of hiding backdoors is called ``security through obscurity''.}
