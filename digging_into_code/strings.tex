...
The standard UNIX \IT{strings} utility is quick-n-dirty way to see strings.
For example, these are some strings from OpenSSH 7.2 sshd binary:
...
There is also unreadable noise---x86 code sometimes has chunks of printable ASCII characters, up to ~8 characters.
...
\RU{Бэкдор активировался при посещении следующего URL:}\EN{The backdoor can activated using the following URL:}\\
