...
\begin{figure}[H]
\centering
\myincludegraphics{digging_into_code/strings/C-string.png}
\caption{Hiew}
\end{figure}
...
\begin{figure}[H]
\centering
\myincludegraphics{digging_into_code/strings/multilang_sampler.png}
\end{figure}
...
\begin{figure}[H]
\centering
\myincludegraphics{digging_into_code/strings/UTF16-string.png}
\caption{Hiew}
\end{figure}
...
\begin{figure}[H]
\centering
\myincludegraphics{digging_into_code/strings/ntoskrnl_UTF16.png}
\caption{Hiew}
\end{figure}
...
\begin{figure}[H]
\centering
\myincludegraphics{digging_into_code/strings/russian_UTF16.png}
