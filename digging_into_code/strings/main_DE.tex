...
Die Ungarische Sprache benutzt Latein Symbole plus ein paar Symbole mit diacritic Marks. % <--- Verbessung finden
...
Es gibt auch das \q{Euro} Währung Symbol im Standard, das Symbol wurde mit 3 Bytes Codiert.

Der Rest der Schreibsysteme haben keine Verbindung/Bezug zum Latein. % <--- Besser formulieren
...
Zu Anfang, noch vor dem \q{How much?} String sehen wir 3 Bytes, die tatsächlich das \ac{BOM} darstellen.
...
Alle Latein Zeichen haben Null Bytes. % <-- Prüfen/Umformulieren verbessern
