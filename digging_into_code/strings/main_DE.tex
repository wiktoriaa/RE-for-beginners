...
\footnote{Beispiel und Übersetzung k\o"nnen von hier bezogen werden:  
...
Das gleiche gilt für die Isl\"andischen und Polnischen Sprachen.

Es gibt auch das \q{Euro} W\a"hrung Symbol im Standard, das Symbol wurde mit 3 Bytes Codiert.

Der Rest der Schreibsysteme hat keinen Bezug zu Latein.

Zumindest in Russisch, Arabisch, Hebr\"aisch und Hindu k\o"nnen wir wiederkehrende Bytes erkennen und das ist nicht mal überraschend:
