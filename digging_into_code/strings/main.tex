...
\RU{В самом начале я также применил символ валюты \q{Евро}, который кодируется тремя байтами}
\EN{I also used the \q{Euro} currency symbol at the start, which is encoded with 3 bytes}.
