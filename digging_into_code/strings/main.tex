...
\EN{The reason why C string format is as it is (zero-terminating) is apparently historical}.
...
\EN{The string in Pascal and Borland Delphi is preceded by 8-bit or 32-bit string length value.}
