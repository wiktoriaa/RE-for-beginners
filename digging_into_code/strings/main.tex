...
\RU{Когда кодируются строки в Pascal и Delphi, сама строка предваряется 8-битным или 32-битным значением,
в котором закодирована длина строки}\EN{The string is preceeded by 8-bit or 32-bit string length value}.
...
\EN{Often, what is called by Unicode is a methods of strings encoding when each character occupies 2 bytes or 16 bits}.
