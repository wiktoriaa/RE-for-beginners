...
\subsubsection{Name mangling} % <-- Übersetzen
...
libifcoremd.dll hat eine menge an Funktionen die das \TT{for\_\ Präfix haben, was \IT{Fortran} bedeutet.
...
Dies ist ein sehr typischer Anfang für das \TT{CODE} Segment bei einem 
