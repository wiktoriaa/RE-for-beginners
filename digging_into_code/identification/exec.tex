...
libifcoremd.dll \AndENRU libifportmd.dll \IFRU{могут импортироваться}{may be imported}.

\IFRU{В }{}libifcoremd.dll \IFRU{много ф-ций с префиксом}{has a lot of functions prefixed with} 
...
\IFRU{Имена обычно начинаются с символа}{Names are usually started with} \TT{W}\IFRU{}{ symbol}.
