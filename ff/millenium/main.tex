...
\RU{Я подождал несколько \q{дней} здесь в игре и теперь в шахте добыто больше ресурсов}\EN{I wait some 
\q{days} here in the game, and now we've got more resources from the mine}:
...
\EN{In the first state, I have 14 \q{units} of hydrogen and 102 \q{units} of oxygen.}
\RU{Во второй версии 22 и 155 единиц соответственно.}
\EN{I have 22 and 155 \q{units} respectively in the second state.}
...
\clearpage
\RU{Я пропустил еще несколько \q{дней} в игре и оппа}\EN{I skipped some \q{days} in the game and oops}! 
