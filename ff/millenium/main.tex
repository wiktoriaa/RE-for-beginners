...
\EN{is an ancient DOS game (1991), allowing to mine resources, build ships,
...
``days'' here in game, and now we've got more resources at the mine}:
...
\RU{Там}\EN{There are} 0x0E (14) \RU{на позиции}\EN{at} 0xBDA \RU{и это значение}\EN{position and this value is} 
...
file into game and taking a look on mine statistics}:
...
finish the game as soon as possible, set maximal values everywhere}:
...
\RU{Некоторых ресурсов стало меньше}\EN{I have lower amount of some resources}:
