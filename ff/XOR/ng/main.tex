\clearpage
\subsection{Norton Guide: \RU{простейшее однобайтное XOR-шифрование}\EN{simplest possible 1-byte XOR encryption}}
\label{norton_guide}
...
\subsubsection{\RU{Энтропия}\EN{Entropy}}
...
\myparagraph{\EN{One more word about base of entropy}\RU{Еще кое-что о базе энтропии}}
