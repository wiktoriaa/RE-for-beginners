\clearpage
\sectionold{Norton Guide: \RU{простейшее однобайтное XOR-шифрование}\EN{simplest possible 1-byte XOR encryption}}
\label{norton_guide}
...
\subsectionold{\RU{Энтропия}\EN{Entropy}}
\myindex{Wolfram Mathematica}
\myindex{\RU{Энтропия}\EN{Entropy}}
...
\subsubsectionold{\EN{One more word about base of entropy}\RU{Еще кое-что о базе энтропии}}
