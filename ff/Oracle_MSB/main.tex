\section{\oracle: \EN{.MSB-files}\RU{.MSB-файлы}\ESph{}\PTBRph{}\PLph{}\ITAph{}\DEph{}\NLph{}}
\myindex{\oracle}
...
\RU{Найдем эти числа в начале блока и отметим их красными линиями}\EN{We will find these numbers at the beginning 
...
\clearpage
\RU{Тут еще есть таблица после заголовка, по всей видимости, содержащая 16-битные значения}\EN{There is also a 
...
\subsection{\RU{Вывод}\EN{Summary}}
