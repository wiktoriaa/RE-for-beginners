...
\EN{But as they say: ``when working toward the solution of a problem, it always helps if you know the answer.''
\footnote{Murphy's Laws, Rule of Accuracy}.}
\RU{Но как говорят: ``работая над решением задачи, всегда полезно знать ответ.''
\footnote{законы Мерфи, правило точности}.}
