\sectionold{Analyzing entropy in Mathematica}
...
\subsectionold{GeoIP ISP database}
...
\subsectionold{TP-Link WR941 firmware}

Now more complex example. I've got firmware for TP-Link WR941 router:

\begin{figure}[H]
\centering
\myincludegraphics{ff/entropy/tplink.png}
\end{figure}
