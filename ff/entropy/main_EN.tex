...
\chapterold{Analyzing unknown binary files using information entropy}
\label{entropy}
\myindex{Entropy}
...
\sectionold{A word about primitive encryption like XORing}
...
\sectionold{More about entropy of executable code}
...
\sectionold{Random number generators}
...
\sectionold{Entropy of various files}
