...
\RU{Строки --- это, очевидно, имена ф-ций и глобальных переменных}\EN{The strings are, obviously, function and global 
variable names}.
...
\RU{Так что имя этой ф-ции, похоже}\EN{So the name of this function seems to be} ``ax\_reg''.
...
так что я могу загружать .idc-скрипт и он выставит имена ф-ций:}
