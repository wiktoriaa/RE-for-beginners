...
\EN{Norton Guide\footnote{\url{http://go.yurichev.com/17116}} was popular in MS-DOS epoch, it was resident program working as hypertext reference.}
\RU{Norton Guide\footnote{\url{http://go.yurichev.com/17116}} был популярен во времена MS-DOS, это была резидентная программа, работающая как
