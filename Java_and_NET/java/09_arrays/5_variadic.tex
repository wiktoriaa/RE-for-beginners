% TODO proof-reading
\subsection{\EN{Variadic functions}\RU{Ф-ции с переменным кол-вом аргументов (variadic)}}

\EN{Variadic functions are in fact use arrays:}
\RU{Ф-ции с переменным кол-вом аргументов (variadic) на самом деле используют массивы:}
