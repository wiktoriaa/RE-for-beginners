% TODO proof-reading
\subsubsection{\EN{Variadic functions}\RU{Функции с переменным кол-вом аргументов (variadic)}}
...
во входном массиве.}
\EN{On the other hand, an array is always homogeneous, i.e., it can't hold elements of 
