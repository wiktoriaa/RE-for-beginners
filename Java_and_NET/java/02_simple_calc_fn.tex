% TODO proof-reading
\sectionold{\EN{Simple calculating functions}\RU{Простая вычисляющая функция}}
...
\EN{\INS{iload\_0} loads the first function argument (a), \INS{iload\_2}\EMDASH{}second (b).}
\RU{\INS{iload\_0} загружает первый аргумент функции (a), \INS{iload\_2}\EMDASH{}второй (b).}
