...
\RU{Используется как хранилище для аргументов ф-ций и локальных переменных.}
...
\RU{В начале идут аргументы ф-ции: начиная с 0, или с 1 
...
\item \EN{Operand stack (or just ``stack'')}\RU{Стек операндов (или просто ``стек'')}.
\EN{It's used for computations and passing arguments while calling other functions.}
\RU{Используется для вычислений и для передачи аргументов во время вызова других ф-ций.}
