...
\EN{String concatenation is done using \TT{StringBuilder} class:}
\RU{Складывание строк происходит при помощи класса \TT{StringBuilder}:}
...
\EN{And again, strings are constructed using \TT{StringBuilder} class and its \TT{append} method,
then constructed string is passed to \TT{println} method:}
\RU{И снова, строки создаются используя класс \TT{StringBuilder} и его метод \TT{append},
