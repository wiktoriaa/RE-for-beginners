% TODO proof-reading
\subsectionold{\EN{Second example}\RU{Второй пример}}
...
\EN{The string concatenation is done using \TT{StringBuilder}:}
...
\EN{And again, the strings are constructed using the \TT{StringBuilder} class and its \TT{append} method,
