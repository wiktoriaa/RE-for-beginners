...
\EN{The string user entered is reloaded at offset 30 and concatenated with the ``Hello, '' string 
using \TT{StringBuilder} class.}
\RU{Строка введенная пользователем перезагружается по смещению 30 и складывается со строкой ``Hello, ''
