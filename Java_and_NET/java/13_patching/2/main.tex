...
It stands for \IT{if equal}, and this is misnomer, I would name it \TT{ifz} (\IT{if zero}), i.e, 
...
1 is always to be at the \ac{TOS} when \TT{ifeq} instruction is executed, 
