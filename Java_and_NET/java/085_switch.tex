...
\EN{The switch() statement is implemented with the \TT{tableswitch} instruction:}
\RU{Выражение switch() реализуется инструкцией \TT{tableswitch}:}
...
\EN{As simple, as possible}\RU{Проще не бывает}:
