...
{MSVC doing it using the \ECX register. Needless to say, it's not a standardized method, other compilers could do it
...
Это все потому что ни компоновщик\footnote{linker}, ни загрузчик DLL \ac{ОС}
