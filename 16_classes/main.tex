...
{So what's going on.
For each object (instance of class \IT{c}) 8 bytes allocated, that is exactly size of 2 variables storage.}
...
{It is also should be noted that compiler deciding when to call constructor and destructor ~--- but that is 
