...
вызвать.}
{If in some environment, where it is not known what type has object, as in the \main function in example,
...
Only somewhere in constructors: there are no other place since nothing more is called in the \main function.}
