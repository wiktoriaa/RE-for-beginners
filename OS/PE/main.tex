...
\item
\RU{На секции данных}\EN{On data section}\EMDASH\RU{флаги }\EN{}\IT{IMAGE\_SCN\_CNT\_INITIALIZED\_DATA}, 
...
(\RU{там принято отладочную информацию сохранять в отдельных PDB-файлах}
\EN{a separate PDB-files are used there for this purpose}).
...
\EN{By the way, relocs are darkened in Hiew, for example} \figname \ref{fig:scanf_ex3_hiew_1}.
