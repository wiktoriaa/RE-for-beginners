...
чтобы установить имена ф-ций}\EN{When loading such programs in \IDA, it will ask for a path to the mfc*.dll files
...
\RU{места, где загрузчик будет проставлять адреса найденных ф-ций}\EN{of the place where the loader
