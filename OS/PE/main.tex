...
\IFRU{здесь}{here}\footnote{\url{https://en.wikipedia.org/wiki/Windows_NT#Releases}}.
...
\IFRU{изменив настройки компиляции}{by changing compiler's options}
...
\item
PE\_add\_import\footnote{\url{http://yurichev.com/PE_add_imports.html}} ---
\IFRU{простая утилита для добавления символа/-ов в таблицу импортов PE-файла}
{simple tool for adding symbol(s) to PE executable import table}.

\item
PE\_patcher\footnote{\url{http://yurichev.com/PE_patcher.html}} --- 
\IFRU{простая утилита для модификации PE-файлов}{simple tool for patching PE executables}.

\item
PE\_search\_str\_refs\footnote{\url{http://yurichev.com/PE_search_str_refs.html}} --- 
\IFRU{простая утилита для поиска ф-ции в PE-файле, где используется некая текстовая строка}
