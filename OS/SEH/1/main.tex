...
\EN{The very first handler is to be called---yours, and it will know about it first, by checking
...
припомнить, применяется ли где-то подобное на практике для исправления ошибок \q{на лету}}
\EN{Nevertheless, I cannot recall
any place where it is used for \q{on-the-fly} error fixing}.
