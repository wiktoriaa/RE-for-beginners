...
\begin{figure}[H]
\centering
\myincludegraphicsSmall{OS/SEH/1/crash_xp1.png}
\caption{Windows XP}
\end{figure}

\begin{figure}[H]
\centering
\myincludegraphicsSmall{OS/SEH/1/crash_xp2.png}
\caption{Windows XP}
\end{figure}

\begin{figure}[H]
\centering
\myincludegraphicsSmall{OS/SEH/1/crash_win7.png}
\caption{Windows 7}
\end{figure}

\begin{figure}[H]
\centering
\myincludegraphicsSmall{OS/SEH/1/crash_win81.png}
\caption{Windows 8.1}
\end{figure}
...
Если код \TT{0xE1223344}, то он возвращает 
