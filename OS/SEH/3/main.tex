...
\RU{Еще одна проблема производительности --- это менять переменную}\EN{Another performance problem is changing the} 
\IT{previous try level} \RU{много раз в течении исполнении ф-ции}\EN{value many times during the function's execution}.
