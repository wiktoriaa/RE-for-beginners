...
\EN{The \IT{security cookie} in the stack is random each time, so hopefully a remote attacker will not be able to predict it.}
\RU{\IT{Security cookie} в стеке случайное каждый раз, так что атакующий, как мы надеемся, не мог предсказать его.}\\
\\
