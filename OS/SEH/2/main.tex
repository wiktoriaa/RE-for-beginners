...
\EN{The filter code is an expression, telling whether this handler code is corresponding to the exception raised}.
...
\RU{Во время атаки переполнения буфера}\EN{During buffer overflow} (\myref{subsec:bufferoverflow})
