...
to MSVC}\footnote{\url{http://go.yurichev.com/17057}}.
...
Wine\footnote{\url{http://go.yurichev.com/17059}}
\AndENRU 
...
\RU{смотрите}\EN{see} \url{http://go.yurichev.com/17061} \RU{для деталей}\EN{for details}.\\
\\
