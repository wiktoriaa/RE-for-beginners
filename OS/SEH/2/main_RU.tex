\subsectionold{Теперь вспомним MSVC}
...
\subsubsectionold{SEH3: пример с одним блоком try/except}
...
\subsubsectionold{SEH3: пример с двумя блоками try/except}
