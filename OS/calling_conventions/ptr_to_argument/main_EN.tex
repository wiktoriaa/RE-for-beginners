...
\lstinputlisting[caption=\Optimizing MSVC 2010,style=customasm]{OS/calling_conventions/ptr_to_argument/MSVC_2010_O3.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2012 x64,style=customasm]{OS/calling_conventions/ptr_to_argument/MSVC_2012_x64_O3.asm}

GCC also stores the input value in the local stack:

\lstinputlisting[caption=\Optimizing GCC 4.9.1 x64,style=customasm]{OS/calling_conventions/ptr_to_argument/GCC491_x64_O3.s}

GCC for ARM64 does the same, but this space is called \IT{Register Save Area} here:

\lstinputlisting[caption=\Optimizing GCC 4.9.1 ARM64,style=customasm]{OS/calling_conventions/ptr_to_argument/GCC49_ARM64_O3.s}
