...
\footnote{\url{http://go.yurichev.com/17043}}:
...
\footnote{\url{http://go.yurichev.com/17143}}
...
\begin{itemize}
\RU{\item
\RU{Перехват}\EN{Intercepting} time() \InENRU Sun Solaris \url{http://go.yurichev.com/17144}
}
...
\url{http://go.yurichev.com/17145}
