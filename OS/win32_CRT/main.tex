...
\EN{If to open any executable file in \IDA or HIEW, we will see \ac{OEP} pointing to another code}.
...
переменные окружения}\EN{\main{} fucntion takes an array of arguments passed in the command line, and also
