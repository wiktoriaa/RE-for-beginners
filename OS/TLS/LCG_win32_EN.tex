...
\subsubsectionold{Uninitialized \ac{TLS} data}
...
\subsubsectionold{Initialized \ac{TLS} data}
...
\item The \TT{my\_rand()} function is called several times in thread A. \TT{rand\_state} is different from 1234.
...
\subsubsectionold{\ac{TLS} callbacks}
