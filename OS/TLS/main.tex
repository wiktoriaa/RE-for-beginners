...
The random number generator we considered earlier (\ref{LCG_simple}) has a flaw: it's not thread-safe, because
it has internal state variable which can be read and/or modified in different threads simultaneously.
