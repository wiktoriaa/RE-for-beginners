...
\RU{Рассмотренный раннее \ref{LCG_simple} генератор псевдослучайных чисел имеет недостаток:}
\EN{The pseudorandom number generator we considered earlier \ref{LCG_simple} has a flaw:}
