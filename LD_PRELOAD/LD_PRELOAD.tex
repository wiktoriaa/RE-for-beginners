...
is working}.
\index{strace}
\IFRU{При помощи}{With the help of} strace\ref{strace}, \IFRU{можно увидеть, что эту информацию утилита получает из файла}{it is possible to see that this information the utility takes from the} \TT{/proc/uptime}
\IFRU{}{ file}:
