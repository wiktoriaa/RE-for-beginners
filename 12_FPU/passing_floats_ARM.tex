...
{This is code is redundant for a little (certainty because optimization is turned off), because,
...
\IFRU{Функция оставляет результат в}{Function leave result in} \Rzero \IFRU{и}{and} \Rone.
