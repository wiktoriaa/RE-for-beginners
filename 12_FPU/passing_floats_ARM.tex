...
{function receiving first argument in} \Rzero \And \Rone, \IFRU{а второй в}{and the second one in} 
\Rtwo \And \Rthree. 
\IFRU{Функция оставляет результат в}{Function leaves result in} \Rzero \And \Rone.
\IFRU{Результат работы}{Result of} \TT{\_pow} \IFRU{перекладывается в}{is moved into} \TT{D16}, 
\IFRU{затем в пару}{then in} \Rone \And \Rtwo\IFRU{}{ pair}, \IFRU{откуда}{from where} 
