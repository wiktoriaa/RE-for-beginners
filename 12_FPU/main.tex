...
\ac{FPU}\IFRU{ ~--- }{~---}\IFRU{блок в процессоре работающий с числами с плавающей запятой.}
...
\input{12_FPU/simple_example}
\input{12_FPU/passing_floats}
\input{12_FPU/comparison_example}
