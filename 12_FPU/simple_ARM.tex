...
\IFRU{Обе константы}{Both} ($3.14$ \And $4.1$) \IFRU{хранятся в памяти в формате IEEE 754.}
{constants are stored in memory in IEEE 754 form.}

\index{ARM!\Instructions!VLDR}
\index{ARM!\Instructions!VMOV}
\IFRU{Инструкции }{}\TT{VLDR} \And \TT{VMOV}
...
\IFRU{остается в двух регистрах}{leaving in two} \Rzero \And \Rone\IFRU{}{ registers},
...
\TT{VDIV}, \TT{VMUL} \And \TT{VADD}, \IFRU{это, собственно, инструкции для работы с числами 
