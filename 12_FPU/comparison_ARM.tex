...
\IFRU{Входные величины помещаются в}{Input values are placed into the} \TT{D17} \IFRU{и}{and} \TT{D16} 
...
assembler will add \TT{IT} instructions automatically, with respectable flags, where it's necessary.}
