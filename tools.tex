...
\footnote{\url{http://go.yurichev.com/17031}{hex-rays.com/products/ida/support/download\_freeware.shtml}}.
...
\url{http://go.yurichev.com/17032}{ollydbg.de}.
...
\url{http://go.yurichev.com/17033}{hex-rays.com/products/decompiler/}
...
\begin{itemize}
\item
Microsoft Visual Studio Express\footnote{\url{http://go.yurichev.com/17034}{visualstudio.com/en-US/products/visual-studio-express-vs}}:
...
\item
\label{Hiew}
Hiew\footnote{\url{http://go.yurichev.com/17035}{hiew.ru}} \RU{для мелкой модификации кода в исполняемых файлах.}
