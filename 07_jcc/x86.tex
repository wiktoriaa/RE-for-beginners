...
\lstinputlisting{07_jcc/7_2.asm}
...
\lstinputlisting{07_jcc/7_3_gcc.asm}
...
{These instructions (\JA/\JAE/\JB/\JBE) are different from \JG/\JGE/\JL/\JLE in that way, 
...
\lstinputlisting{07_jcc/7_4.asm}
