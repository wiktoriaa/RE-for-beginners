...
\Huge \RU{Внимание: это сокращенная LITE-версия}\EN{Warning: this is a shortened LITE-version}!
\normalsize
...
\EN{If you still interesting in reverse engineering, full version of the book is always available on my website}: 
