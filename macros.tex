...
\newcommand{\NonOptimizingKeil}{\IFRU{Неоптимизирующий}{Non-optimizing} Keil}
\newcommand{\OptimizingKeil}{\IFRU{Оптимизирующий}{Optimizing} Keil}
\newcommand{\NonOptimizingXcode}{\IFRU{Неоптимизирующий}{Non-optimizing} Xcode (LLVM)}
\newcommand{\OptimizingXcode}{\IFRU{Оптимизирующий}{Optimizing} Xcode (LLVM)}
