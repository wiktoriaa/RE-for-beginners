...
\newcommand{\LANG}{\RU{ru}\EN{en}\ES{es}\PTBR{ptbr}}
...
% without dot!
\newcommand{\etc}{\RU{и~т.д}\EN{etc}\PTBRph{}\ESph{}}

% http://tex.stackexchange.com/questions/32160/new-line-after-paragraph
\newcommand{\myparagraph}[1]{\paragraph{#1}\mbox{}\\} 

\newcommand{\figname}{\RU{илл}\EN{fig}\PTBRph{}\ESph{}.\xspace}
\newcommand{\figref}[1]{\figname{}\ref{#1}\xspace}
\newcommand{\listingname}{\RU{листинг}\EN{listing}\PTBRph{}\ESph{}.\xspace}
\newcommand{\lstref}[1]{\listingname{}\ref{#1}\xspace}
\newcommand{\bitENRU}{\RU{бит}\EN{bit}\PTBRph{}\ESph{}\xspace}
\newcommand{\bitsENRU}{\RU{бита}\EN{bits}\PTBRph{}\ESph{}\xspace}
\newcommand{\Sourcecode}{\RU{Исходный код}\EN{Source code}\PTBRph{}\ESph{}\xspace}
\newcommand{\Seealso}{\RU{См. также}\EN{See also}\PTBRph{}\ESph{}\xspace}
...
\newcommand{\tableheader}{\headercolor{} \RU{смещение}\EN{offset}\PTBRph{}\ESph{} & \headercolor{} \RU{описание}\EN{description}\PTBRph{}\SPph{}}
...
\newcommand{\ASRdesc}{\RU{арифметический сдвиг вправо}\EN{arithmetic shift right}\PTBRph{}\ESph{}}
