...
\ifdefined\SPANISH{}
\newcommand*{\SP}[1]{\iflanguage{spanish}{#1}{}}
\else
\newcommand*{\SP}[1]{}
\fi
...
\newcommand{\LANG}{\RU{ru}\EN{en}\SP{sp}\PTBR{ptbr}}

\newcommand{\SPph}{\SP{Spanish text placeholder}}
...
% without dot!
\newcommand{\etc}{\RU{и~т.д}\EN{etc}\PTBRph{}\SPph{}}

% http://tex.stackexchange.com/questions/32160/new-line-after-paragraph
\newcommand{\myparagraph}[1]{\paragraph{#1}\mbox{}\\} 

\newcommand{\figname}{\RU{илл}\EN{fig}\PTBRph{}\SPph{}.\xspace}
\newcommand{\figref}[1]{\figname{}\ref{#1}\xspace}
\newcommand{\listingname}{\RU{листинг}\EN{listing}\PTBRph{}\SPph{}.\xspace}
\newcommand{\lstref}[1]{\listingname{}\ref{#1}\xspace}
\newcommand{\bitENRU}{\RU{бит}\EN{bit}\PTBRph{}\SPph{}\xspace}
\newcommand{\bitsENRU}{\RU{бита}\EN{bits}\PTBRph{}\SPph{}\xspace}
\newcommand{\Sourcecode}{\RU{Исходный код}\EN{Source code}\PTBRph{}\SPph{}\xspace}
\newcommand{\Seealso}{\RU{См. также}\EN{See also}\PTBRph{}\SPph{}\xspace}
...
\newcommand{\tableheader}{\headercolor{} \RU{смещение}\EN{offset}\PTBRph{}\SPph{} & \headercolor{} \RU{описание}\EN{description}\PTBRph{}\SPph{}}
...
\newcommand{\ASRdesc}{\RU{арифметический сдвиг вправо}\EN{arithmetic shift right}\PTBRph{}\SPph{}}
