...
\newcommand{\figname}{\IFRU{илл}{fig}.\xspace}
\newcommand{\bitENRU}{\IFRU{бит}{bit}\xspace}
\newcommand{\Sourcecode}{\IFRU{Исходный код}{Source code}\xspace}
\newcommand{\Seealso}{\IFRU{См. также}{See also}\xspace}
