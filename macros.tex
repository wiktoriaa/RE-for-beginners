...
\newcommand*{\IFRU}[2]{\iflanguage{english}{#2}{#1}}
\newcommand*{\dittoclosing}{---''---}
\newcommand*{\EMDASH}{\IFRU{ --- }{---}}

% TODO non-overlapping color!
% \newcommand{\headercolor}{\cellcolor{blue!25}}
\newcommand{\headercolor}{}

\newcommand{\tableheader}{\headercolor{} \IFRU{смещение}{offset} & \headercolor{} \IFRU{описание}{description}}

\newcommand{\IDA}{\ac{IDA}\xspace}

\newcommand{\tracer}{\IT{tracer}~\textsuperscript{\ref{tracer}}\xspace}
...
% ARM
\newcommand{\PCwithfootnote}{\ac{PC}\footnote{EIP, RIP \InENRU x86}\xspace}
\newcommand{\SPwithfootnote}{\ac{SP}\footnote{ESP, RSP \InENRU x86}\xspace}
\newcommand{\Rzero}{\TT{R0}\xspace}
\newcommand{\Rone}{\TT{R1}\xspace}
\newcommand{\Rtwo}{\TT{R2}\xspace}
\newcommand{\Rthree}{\TT{R3}\xspace}
\newcommand{\Rfour}{\TT{R4}\xspace}
\newcommand{\ADREQ}{\TT{ADREQ}\xspace}
\newcommand{\ADRNE}{\TT{ADRNE}\xspace}
\newcommand{\BEQ}{\TT{BEQ}\xspace}

%\newcommand{\LR}{\TT{LR}\xspace}
%\newcommand{\PC}{\TT{PC}\xspace}
%\newcommand{\SP}{\TT{SP}\xspace}
\newcommand{\LR}{\ac{LR}\xspace}
\newcommand{\PC}{\ac{PC}\xspace}
\newcommand{\SP}{\ac{SP}\xspace}

% instructions descriptions
\newcommand{\ASRdesc}{\IFRU{арифметический сдвиг вправо}{arithmetic shift right}}
\newcommand{\LDMFDDESC}{Load Multiple Full Descending}
\newcommand{\STMFDdesc}{Store Multiple Full Descending}
\newcommand{\STMEDdesc}{Store Multiple Empty Descending}
\newcommand{\LDMEDdesc}{Load Multiple Empty Descending}
\newcommand{\STMFAdesc}{Store Multiple Full Ascending}
\newcommand{\LDMFAdesc}{Load Multiple Full Ascending}
\newcommand{\STMEAdesc}{Store Multiple Empty Ascending}
\newcommand{\LDMEAdesc}{Load Multiple Empty Ascending}
