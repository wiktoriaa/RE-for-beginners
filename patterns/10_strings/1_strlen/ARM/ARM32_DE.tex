...
(\ARMMode),label=ARM_leaf_example7,style=customasm]{patterns/10_strings/1_strlen/ARM/xcode_ARM_O0_DE.asm}
...
\lstinputlisting[caption=\OptimizingXcodeIV (\ThumbMode),style=customasm]{patterns/10_strings/1_strlen/ARM/xcode_thumb_O3.asm}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),label=ARM_leaf_example6,style=customasm]{patterns/10_strings/1_strlen/ARM/Keil_ARM_O3.asm}
