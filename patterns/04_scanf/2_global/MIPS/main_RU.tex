...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/04_scanf/2_global/MIPS/O3_IDA_RU.lst}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/04_scanf/2_global/MIPS/O3_IDA_init_RU.lst}
