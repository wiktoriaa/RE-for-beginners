...
Während der Dauer der Funktionsausführung zeigt \EBP auf den aktuellen \gls{Stack Frame}, wodurch mittels \TT{EBP+offset} auf lokalen Variablen und Funktionsargumente zugegriffen werden kann.
