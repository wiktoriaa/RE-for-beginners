...
\lstinputlisting[style=customasm]{patterns/04_scanf/1_simple/ARM_IDA.lst}
...
\lstinputlisting[caption=\NonOptimizing GCC 4.9.1 ARM64,numbers=left,style=customasm]{patterns/04_scanf/1_simple/ARM64_GCC491_O0_EN.s}
