...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (\assemblyOutput),style=customasm]{patterns/04_scanf/1_simple/MIPS/ex1.O3_EN.s}

IDA displays the stack layout as follows:

\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/04_scanf/1_simple/MIPS/ex1.O3.IDA_EN.lst}
