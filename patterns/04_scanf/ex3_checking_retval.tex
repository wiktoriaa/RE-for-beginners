\section{\IFRU{Проверка результата scanf()}{scanf() result checking}}
...
\IFRU{По стандарту}{By standard}, 
\scanf\footnote{MSDN: scanf, wscanf: \url{http://msdn.microsoft.com/en-us/library/9y6s16x1(VS.71).aspx}} 
\IFRU{возвращает количество успешно полученных значений.}
{function returns number of fields it successfully read.}
...
\input{patterns/04_scanf/ex3_checking_retval_x86}
\input{patterns/04_scanf/ex3_checking_retval_x64}
\input{patterns/04_scanf/ex3_checking_retval_ARM}
