...
\EN{\scanf returns result of its work in \$V0 register, and it's checked at address 0x004006E4
...
\EN{If values are equal (i.e., success), jump to the address 0x0040070C is occurred.}
