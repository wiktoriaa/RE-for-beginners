...
\EN{Since in this case the second \printf should not be executed, there is a \JMP preceding it (unconditional jump). It will pass the control to the point after the second \printf and just before the \TT{XOR EAX, EAX} instruction, which implements \TT{return 0}.}
...
should bypass, is located}), \RU{нажмите}\EN{press} F3,
...
not the most aesthetic approach}.
