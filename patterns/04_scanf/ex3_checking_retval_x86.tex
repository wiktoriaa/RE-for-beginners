...
\RU{Я сделал это для трех блоков}\EN{I did it for 3 blocks}: \figname{} \ref{fig:ex3_IDA_2}.
...
\EN{which mean, an error occurred}: \figname \ref{fig:scanf_ex3_olly_2}.
...
\RU{Мы увидим следующее}\EN{We will see this}: \figname \ref{fig:scanf_ex3_hiew_1}.
