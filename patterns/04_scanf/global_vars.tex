...
Место в исполняемом файле для нее не определено (и действительно, зачем в исполняемом файле
...
There are no place for it in the executable file (indeed, why we should allocate a place
