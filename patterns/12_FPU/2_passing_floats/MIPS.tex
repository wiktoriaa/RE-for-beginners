...
\EN{The new instruction for us here is} MFC1 (``Move From Coprocessor 1'')\RU{ (копировать из первого сопроцессора)}.
\RU{FPU это сопроцессор под номером 1, вот откуда ``1'' в имени инструкции.}
\EN{The FPU is coprocessor number 1, hence ``1'' in the instruction name.}
...
and \printf will take a 64-bit double value from this register pair.}
