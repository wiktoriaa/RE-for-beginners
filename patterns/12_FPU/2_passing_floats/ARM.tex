...
\RU{Итак, видно, что функция}\EN{So, as we see, the} \GTT{\_pow} \RU{получает первый аргумент в}
...
\RU{Результат работы}\EN{The result of} \GTT{\_pow} \RU{перекладывается в}\EN{is moved into} \GTT{D16}, 
