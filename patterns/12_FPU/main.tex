...
\newcommand{\FNURLSTACK}{\footnote{\url{http://go.yurichev.com/17123}}}
\newcommand{\FNURLFORTH}{\footnote{\url{http://go.yurichev.com/17124}}}
\newcommand{\FNURLIEEE}{\footnote{\url{http://go.yurichev.com/17125}}}
\newcommand{\FNURLSP}{\footnote{\url{http://go.yurichev.com/17126}}}
\newcommand{\FNURLDP}{\footnote{\url{http://go.yurichev.com/17127}}}
\newcommand{\FNURLEP}{\footnote{\url{http://go.yurichev.com/17128}}}
...
\EN{It was called coprocessor in past and it stay aside of the main \ac{CPU}.}
...
\EN{It is worth to study stack machines\FNURLSTACK{} before \ac{FPU} in x86 studying, 
or learn Forth language basics\FNURLFORTH.}\\
\\
\index{Intel!80486}
\index{Intel!FPU}
...
\EN{FPU in ARM and MIPS is not a stack, it's just registers set.}
\RU{Такая же идеология применяется в расширениях SIMD в процессорах x86/x64.}
\EN{The same ideology is used in SIMD extensions of x86/x64 CPUs.}
