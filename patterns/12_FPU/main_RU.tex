...
В [\TAOCPvolII 246] мы можем найти что \IT{single-precision} означает что значение с плавающей точкой может быть
...
\sectionold{Стек, калькуляторы и обратная польская запись}
