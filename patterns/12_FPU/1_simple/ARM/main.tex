...
\RU{Инструкции }\INS{VLDR} \AndENRU \INS{VMOV}%
\RU{, как можно догадаться, это аналоги обычных \INS{LDR} и \MOV, но они работают с D-регистрами.}
\EN{, as it can be easily deduced, are analogous to the \INS{LDR} and \MOV instructions,
...
\INS{VMOV D17, R0, R1} \RU{в самом начале составляет два 32-битных значения из \Reg{0} и \Reg{1} 
...
\INS{VMOV R0, R1, D16} \RU{в конце это обратная процедура}\EN{is the inverse operation}: 
\RU{то что было в}\EN{what was in} \GTT{D16} 
...
\INS{VDIV}, \INS{VMUL} \AndENRU \INS{VADD}, \RU{это инструкции для работы с числами 
...
\GTT{\_\_aeabi\_dmul}, \GTT{\_\_aeabi\_ddiv}, \GTT{\_\_aeabi\_dadd}%
...
(the last two \INS{FMOV} instructions).}
