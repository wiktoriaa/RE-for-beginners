...
\lstinputlisting[label=ARM_leaf_example10,caption=\OptimizingXcodeIV (\ARMMode),style=customasm]{patterns/12_FPU/1_simple/ARM/Xcode_ARM_O3_EN.asm}
...
\lstinputlisting[style=customasm]{patterns/12_FPU/1_simple/ARM/Keil_O3_thumb_EN.asm}
...
\lstinputlisting[caption=\Optimizing GCC (Linaro) 4.9,style=customasm]{patterns/12_FPU/1_simple/ARM/ARM64_GCC_O3_EN.s}

\subsubsection{ARM64: \NonOptimizing GCC (Linaro) 4.9}

\lstinputlisting[caption=\NonOptimizing GCC (Linaro) 4.9,style=customasm]{patterns/12_FPU/1_simple/ARM/ARM64_GCC_O0_EN.s}
