...
\RU{\FDIV делит содержимое регистра \ST{0} на число, лежащее по адресу \GTT{\_\_real@40091eb851eb851f}~--- 
...
\RU{Следующий \FMUL умножает $b$ из \ST{0} на значение \GTT{\_\_real@4010666666666666}~--- 
