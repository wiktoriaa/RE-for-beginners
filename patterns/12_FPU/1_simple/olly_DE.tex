...
\FDIV wurde ausgeführt, nun enthält \ST{0} also 0.382\ldots (\gls{Quotient}):
...
\end{figure}
Gleichzeitig wird der \gls{Quotient} nach \ST{1} verschoben.
In diesem Moment zeigt \EIP auf den nächsten Befehl: \FMUL.
Dieser lädt die Konstante 4.1 aus dem Speicher, wie \olly zeigt.

\clearpage
Dann: \FMUL wurde ausgeführt, sodass das \gls{Produkt} jetzt in \ST{0} liegt.
