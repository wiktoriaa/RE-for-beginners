...
\RU{Обе}\EN{Both} \FLD \RU{отработали}\EN{executed}: \ref{fig:FPU_comparison_Ox_case1_olly1}.
...
\FCOM \RU{сработала}\EN{is done}: \ref{fig:FPU_comparison_Ox_case1_olly2}.
\Czero \RU{установлен, остальные флаги сброшены}\EN{is set, all other condition flags are cleared}.

\FNSTSW \RU{сработала}\EN{is done}, \TT{AX}=0x3100: \ref{fig:FPU_comparison_Ox_case1_olly3}.

\TEST \RU{сработала}\EN{executed}: \ref{fig:FPU_comparison_Ox_case1_olly4}.
...
and $3.4$ was leaved on top of it}.
\ref{fig:FPU_comparison_Ox_case1_olly5}.
...
\RU{Обе}\EN{Both} \FLD \RU{отработали}\EN{executed}: \ref{fig:FPU_comparison_Ox_case2_olly1}.
\RU{Сейчас будет исполняться }\FCOMP\EN{ being executed}.

\FCOM \RU{сработала}\EN{done}: \ref{fig:FPU_comparison_Ox_case2_olly2}.
\RU{Все condition-флаги сброшены}\EN{All condition-flags are cleared}.

\FNSTSW \RU{сработала}\EN{done}, \TT{AX}=0x3000: \ref{fig:FPU_comparison_Ox_case2_olly3}.

\TEST \RU{сработала}\EN{is done}: \ref{fig:FPU_comparison_Ox_case2_olly4}.
...
\ref{fig:FPU_comparison_Ox_case2_olly5}.
