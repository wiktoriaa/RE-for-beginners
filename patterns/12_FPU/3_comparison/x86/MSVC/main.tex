...
\RU{Загружаем пример в}\EN{Let's load the example into} \olly: \ref{fig:FPU_comparison_case1_olly1}.
...
\\
\FCOMP \RU{отработал}\EN{executed}: \ref{fig:FPU_comparison_case1_olly2}.
...
\\
\FNSTSW \RU{сработал}\EN{executed}: \ref{fig:FPU_comparison_case1_olly3}.
...
\\
\TEST \RU{сработал}\EN{executed}: \ref{fig:FPU_comparison_case1_olly4}.
...
\EN{loads \IT{b} ($3.4$) value into \ST{0}}: \ref{fig:FPU_comparison_case1_olly5}.
...
\RU{Загружаем пример в}\EN{Let's load example into} \olly: \ref{fig:FPU_comparison_case2_olly1}.
...
\\
\FCOMP \RU{отработал}\EN{executed}: \ref{fig:FPU_comparison_case2_olly2}.
...
\\
\FNSTSW \RU{сработал}\EN{executed}: \ref{fig:FPU_comparison_case2_olly3}.
...
\\
\TEST \RU{сработал}\EN{executed}: \ref{fig:FPU_comparison_case2_olly4}.
...
\EN{loads \IT{a} value ($5.6$) into \ST{0}}: \ref{fig:FPU_comparison_case2_olly5}.
\RU{Ф-ция заканчивает свою работу}\EN{The function finishes its work}.
