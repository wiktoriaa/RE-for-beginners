...
``D'' \EN{means values of type}\RU{означает переменные типа} \Tdouble.
...
``T'' \EN{mean that the jump will be taken if the bit is set}\RU{означает что переход произойдет если бит выставлен} (``True'').
