...
\RU{В нашем примере}\EN{In our example}, \TT{``IT GT''} \RU{означает,}\EN{means}
...
\TT{ITE} \RU{означает}\EN{means} \IT{if-then-else} 
...
\EN{means that the 1st and 2nd instructions will be executed }
