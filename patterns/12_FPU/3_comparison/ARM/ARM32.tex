...
условия, например \TT{MOVEQ}, то ассемблер автоматически будет добавлять инструкцию \TT{IT} с соответствующими флагами, там,
где надо.}
\EN{By the way, if you program in ARM assembly language manually for thumb-2 mode, 
and you add conditional suffixes, like \TT{MOVEQ},
