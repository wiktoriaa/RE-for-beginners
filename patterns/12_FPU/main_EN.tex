...
\sectionold{ARM, MIPS, x86/x64 SIMD}
...
In [\TAOCPvolII 246] we can find the \IT{single-precision} means that the floating point value can be placed into a single
...
\sectionold{Stack, calculators and reverse Polish notation}
