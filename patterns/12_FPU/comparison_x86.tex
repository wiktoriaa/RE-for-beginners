...
\lstinputlisting[caption=MSVC 2010]{patterns/12_FPU/12_4_\IFRU{ru}{en}.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2010]{patterns/12_FPU/12_5_\IFRU{ru}{en}.asm}
...
\lstinputlisting[caption=GCC 4.4.1]{patterns/12_FPU/12_6_\IFRU{ru}{en}.asm}
...
\label{SAHF}
\IFRU{Далее мы видим \SAHF ~--- это довольно редкая инструкция в коде не использующим FPU. 
...
\lstinputlisting[caption=\Optimizing GCC 4.4.1]{patterns/12_FPU/12_7_\IFRU{ru}{en}.asm}
...
\IFRU{Вполне возможно, что биты статуса FPU \CThreeBits преднамеренно были размещены таким образом, 
