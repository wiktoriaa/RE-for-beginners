...
a pointer to}
\TT{sum}\IFRU{}{ array}, \TT{product}\IFRU{}{ array}, \IFRU{или даже}{or even} 
\TT{sum\_product}\IFRU{}{ array}\IFRU{ ~--- }{~---}\IFRU{ведь нет ничего криминального в том 
...
\item \IFRU{вычислить следующий}{calculate next} \TT{sum\_product[i]}\IFRU{ ~--- }{~---}\IFRU{на этой стадии придется снова загружать из памяти подсчитанные}
...
\lstinputlisting[caption=GCC x64: f1()]{patterns/21_C99_restrict/f1.asm}

\lstinputlisting[caption=GCC x64: f2()]{patterns/21_C99_restrict/f2.asm}
