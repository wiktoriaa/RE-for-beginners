include(`commons.m4')$SG4228	DB	'Enter temperature in Fahrenheit:', 0aH, 00H
$SG4230	DB	'%d', 00H
...
_main	PROC
	...
	call	esi			; _EN(`call')_RU(`вызвать') printf()
...
$LN1@main:
	...
	call	esi			; _EN(`call')_RU(`вызвать') printf()
	add	esp, 8
	; _EN(`return 0 - by C99 standard')_RU(`возврат 0 - по стандарту C99')
	xor	eax, eax
	pop	esi
	pop	ecx
	ret	0
