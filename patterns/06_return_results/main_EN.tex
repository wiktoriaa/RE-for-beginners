\chapterold{More about results returning}
...
\sectionold{Attempt to use the result of a function returning \Tvoid}
...
\sectionold{What if we do not use the function result?}
...
\sectionold{Returning a structure}
