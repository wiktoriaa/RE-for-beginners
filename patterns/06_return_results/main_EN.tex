...
some class:
мы разбираем C++ код, нередко можно наткнуться на ф-цию, которая заканчивается
...
\lstinputlisting[style=customasm]{patterns/06_return_results/6_1.asm}
...
\lstinputlisting[caption=GCC 4.8.1,style=customasm]{patterns/06_return_results/6_1_C99.asm}
