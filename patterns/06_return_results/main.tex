\chapter{\RU{И еще немного о возвращаемых результатах}\EN{One more word about results returning.}}
...
\EN{Most likely, there will be a random value, leaved from your function execution.}
...
\RU{будет содержать то, что}\EN{finish will contain what} \puts \RU{оставит там}\EN{leaved there}.
...
\EN{Let's back to the fact the returning value is leaved in the \EAX register}.
...
\RU{Как видно, ф-ция просто заполняет поля в структуре, выделенной вызывающей ф-цией. Так что никаких проблем
с эффективностью нет.}\EN{As we may see, the function is just filling fields in the structure, allocated by
