...
\RU{Это значит, \EAX перед выходом из \main будет содержать то, что \puts оставит там.}
\EN{This implies that the value of \EAX at the end of \main will contain what \puts has left there.}
