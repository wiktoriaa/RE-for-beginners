\chapterold{Ulteriori considerazioni sulla restituzione dei risultati}
...
\sectionold{Tentativo di utilizzare il risultato di una funzione che resituisce \Tvoid}
...
\sectionold{Che ssucede se il risultato della funzione non viene usato?}
...
\sectionold{Restituire una struttura}
