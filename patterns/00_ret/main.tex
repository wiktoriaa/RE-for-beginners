...
\EN{There are two ways of registers naming are used in the MIPS world.}
\RU{По номеру (от \$0 до \$31) или по псевдоимени (\$V0, \$A0, итд).}
...
\EN{By why load instruction (LI) and jump instruction (J or JR) are swapped?}
...
\EN{But I decided to stick to uppercase, because instruction and register names of other \ac{ISA}s 
