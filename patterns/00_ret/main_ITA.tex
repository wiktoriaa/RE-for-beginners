\chapterold{La funzione più semplice}
...
così che l'istruzione \INS{BX LR} faccia in modo che l'esecuzione "salti" a quell'indirizzo \EMDASH{} restituendo effettivamente l'esecuzione alla funzione \glslink{caller}{chiamante}.
...
\subsectionold{Una nota sui nomi delle istruzioni e dei registri MIPS}
