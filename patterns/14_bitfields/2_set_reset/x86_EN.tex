...
\lstinputlisting[caption=MSVC 2010,style=customasm]{patterns/14_bitfields/2_set_reset/set_reset_msvc.asm}
...
\lstinputlisting[caption=\Optimizing MSVC,style=customasm]{patterns/14_bitfields/2_set_reset/set_reset_msvc_Ox.asm}

\myparagraph{\NonOptimizing GCC}

Let's try GCC 4.4.1 without optimization:

\lstinputlisting[caption=\NonOptimizing GCC,style=customasm]{patterns/14_bitfields/2_set_reset/set_reset_gcc.asm}
...
\lstinputlisting[caption=\Optimizing GCC,style=customasm]{patterns/14_bitfields/2_set_reset/set_reset_gcc_O3.asm}
...
\lstinputlisting[caption=\Optimizing GCC,style=customasm]{patterns/14_bitfields/2_set_reset/set_reset_gcc_O3_regparm3.asm}
