...
\hline
\HeaderColor \RU{Выражение в }\CCpp\EN{ expression} & 
\HeaderColor \RU{Степень двойки}\EN{Power of two} & 
\HeaderColor \RU{Десятичная форма}\EN{Decimal form} & 
\HeaderColor \RU{Шестнадцатеричная форма}\EN{Hexadecimal form} \\
\hline
$1 \ll 0$ & 1 & 1 & 1 \\
\hline
$1 \ll 1$ & $2^{1}$ & 2 & 2 \\
...
\input{patterns/14_bitfields/4_popcnt/MIPS}
\fi
