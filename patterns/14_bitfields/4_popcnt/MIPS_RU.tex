...
\lstinputlisting[caption=\NonOptimizing GCC 4.4.5 (IDA),style=customasm]{patterns/14_bitfields/4_popcnt/MIPS_O0_IDA_RU.lst}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/14_bitfields/4_popcnt/MIPS_O3_IDA_RU.lst}
