...
\EN{The}\RU{Инструкция} \TT{CSEL} \RU{это}\EN{instruction is} \q{Conditional SELect}\RU{ (выбор при условии)}, 
...
\RU{И снова, я использовал 64-битный пример, который я уже использовал ранее}\EN{And again, the 64-bit 
