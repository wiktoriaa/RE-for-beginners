...
\EN{These modificators define, how to shift second operand and by how many bits.}
...
into} \RegW{2}\RU{, содержащий переменную ``rt''}\EN{ register, which holds ``rt'' variable}.
