...
\lstinputlisting{patterns/14_bitfields/4_CRC32/CRC.c}
...
\lstinputlisting{patterns/14_bitfields/4_CRC32/CRC_2_\LANG.asm}

\RU{Попробуем то же самое в GCC 4.4.1 с опцией \Othree:}
\EN{Let's try the same in GCC 4.4.1 with \Othree option:}

\lstinputlisting{patterns/14_bitfields/4_CRC32/CRC_gcc_O3_\LANG.asm}
