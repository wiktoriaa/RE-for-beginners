...
\lstinputlisting[caption=GCC 4.4.1,style=customasm]{patterns/14_bitfields/1_check/check.asm}
...
\lstinputlisting[caption=do\_filp\_open() (linux kernel 2.6.31),style=customasm]{patterns/14_bitfields/1_check/check2_EN.asm}
...
\lstinputlisting[caption=do\_filp\_open() (linux kernel 2.6.31),style=customasm]{patterns/14_bitfields/1_check/check3.asm}
