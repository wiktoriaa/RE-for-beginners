...
\EN{If \ANDIns instruction leaves this bit, the \ZF flag is to be cleared and the 
...
~---then the result of \ANDIns is $0$, \ZF is to be set and the conditional jump is to be triggered.}
