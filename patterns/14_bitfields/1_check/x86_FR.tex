...
Donc, le champ de bits pour \TT{open()} est apparement testé quelque part dans le
noyau Linux.
...
uin environnement trop étroit pour l'\glslink{register allocator}{allocateur de registres}
du compilateur.
...
Le bit \TT{0x40} de \TT{open\_flag} est testé, et si il est a 1, le saut de l'instruction
