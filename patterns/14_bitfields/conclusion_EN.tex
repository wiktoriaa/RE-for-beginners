...
\lstinputlisting[caption=x86,style=customasm]{patterns/14_bitfields/TEST_JNZ_EN.lst}

\lstinputlisting[caption=x86,style=customasm]{patterns/14_bitfields/TEST_JZ_EN.lst}

\lstinputlisting[caption=ARM (\ARMMode),style=customasm]{patterns/14_bitfields/TST_BNE_EN.lst}
