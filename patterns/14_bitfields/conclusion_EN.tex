...
\subsectionold{Check for specific bit (known at compile stage)}
...
\subsectionold{Check for specific bit (specified at runtime)}
...
\subsectionold{Set specific bit (known at compile stage)}
...
\subsectionold{Set specific bit (specified at runtime)}
...
\subsectionold{Clear specific bit (known at compile stage)}
