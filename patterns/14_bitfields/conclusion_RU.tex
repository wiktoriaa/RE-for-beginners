...
\lstinputlisting[caption=x86,style=customasm]{patterns/14_bitfields/TEST_JNZ_RU.lst}

\lstinputlisting[caption=x86,style=customasm]{patterns/14_bitfields/TEST_JZ_RU.lst}

\lstinputlisting[caption=ARM (\ARMMode),style=customasm]{patterns/14_bitfields/TST_BNE_RU.lst}
