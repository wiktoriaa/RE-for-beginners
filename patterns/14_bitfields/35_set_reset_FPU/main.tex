...
установки (BTS: \q{set}) и инвертирования (BTC: \q{complementing}).}
...
\q{ADD register, 0x80000000} \RU{работает так же как и}\EN{works just like} \q{XOR register, 0x80000000}.
