...
\EN{my\_abs code is weird and it's effectively works like this expression}: $(i<<1)>>1$.
...
but \ac{MSB} is zero, because all ``new'' bits appeared in shift operations are always zeroes.}
