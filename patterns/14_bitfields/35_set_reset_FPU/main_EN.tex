...
\subsection{A word about the \XOR operation}
...
\lstinputlisting[caption=\Optimizing GCC 4.6.3 for Raspberry Pi (\ARMMode)]{patterns/14_bitfields/35_set_reset_FPU/raspberry_GCC_O3_ARM_mode.lst.\LANG}
