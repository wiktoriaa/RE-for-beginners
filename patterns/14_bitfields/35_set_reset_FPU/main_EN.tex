...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/14_bitfields/35_set_reset_FPU/MIPS_O3_IDA_EN.lst}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),style=customasm]{patterns/14_bitfields/35_set_reset_FPU/abs_Keil_ARM_O3_EN.s}
...
\lstinputlisting[caption=\Optimizing GCC 4.6.3 for Raspberry Pi (\ARMMode),style=customasm]{patterns/14_bitfields/35_set_reset_FPU/raspberry_GCC_O3_ARM_mode_EN.lst}
