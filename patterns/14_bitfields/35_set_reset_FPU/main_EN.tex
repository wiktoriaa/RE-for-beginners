\sectionold{Setting and clearing specific bits: \ac{FPU} example}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode)]{patterns/14_bitfields/35_set_reset_FPU/abs_Keil_ARM_O3_EN.s}
...
\subsubsectionold{\Optimizing GCC 4.6.3 (Raspberry Pi, \ARMMode)}
...
\INS{ADD register, 0x80000000} works just like \INS{XOR register, 0x80000000}.
