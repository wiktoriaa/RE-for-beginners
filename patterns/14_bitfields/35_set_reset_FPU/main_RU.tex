...
\lstinputlisting[caption=\Optimizing MSVC 2012,style=customasm]{patterns/14_bitfields/35_set_reset_FPU/abs_MSVC2012_Ox.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2012 x64,style=customasm]{patterns/14_bitfields/35_set_reset_FPU/abs_MSVC2012_x64_Ox.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/14_bitfields/35_set_reset_FPU/MIPS_O3_IDA_RU.lst}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),style=customasm]{patterns/14_bitfields/35_set_reset_FPU/abs_Keil_ARM_O3_RU.s}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ThumbMode),style=customasm]{patterns/14_bitfields/35_set_reset_FPU/abs_Keil_thumb_O3.s}
...
\lstinputlisting[caption=\Optimizing GCC 4.6.3 для Raspberry Pi (\ARMMode),style=customasm]{patterns/14_bitfields/35_set_reset_FPU/raspberry_GCC_O3_ARM_mode_RU.lst}
