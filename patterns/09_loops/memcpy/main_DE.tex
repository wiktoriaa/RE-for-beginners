...
=======
\subsection{Funktion zum Kopieren von SpeicherblÃ¶cken}
\label{loop_memcpy}

Echte Funktionen zum Kopieren von SpeicherblÃ¶cken kopieren in jedem Schritt 4
oder 8 Byte und verwenden \ac{SIMD}, Vektorisierung, etc.
Aber um einen Eindruck zu erhalten betrachte dieses einfachstmÃ¶gliche Beispiel.
...
\lstinputlisting[caption=GCC 4.9 x64 optimized for size
(-Os),style=customasm]{patterns/09_loops/memcpy/memcpy_GCC49_x64_Os_DE.s}

\lstinputlisting[caption=GCC 4.9 ARM64 optimized for size
(-Os),style=customasm]{patterns/09_loops/memcpy/memcpy_GCC49_ARM64_Os_DE.s}

\lstinputlisting[caption=\OptimizingKeilVI
(\ThumbMode),style=customasm]{patterns/09_loops/memcpy/memcpy_Keil_Thumb_O3_DE.s}
...
\lstinputlisting[caption=\OptimizingKeilVI
(\ARMMode),style=customasm]{patterns/09_loops/memcpy/memcpy_Keil_ARM_O3_DE.s}
...
=======
Wenn wir also mit einzelnen Bytes arbeiten, mÃ¼ssen wir stets ein komplettes
32-bit-Register hierfÃ¼r verwenden.

\INS{LBU} lÃ¤dt ein Byte und lÃ¶scht alle anderen Bits (\q{Unsigned}).
>>>>>>> 33058039def6268466867db95246998137625356
