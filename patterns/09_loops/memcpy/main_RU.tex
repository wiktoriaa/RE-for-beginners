...
\lstinputlisting[caption=GCC 4.9 x64 оптимизация по размеру (-Os)]{patterns/09_loops/memcpy/memcpy_GCC49_x64_Os.s.\LANG}

\ifdefined\IncludeARM

\lstinputlisting[caption=GCC 4.9 ARM64 оптимизация по размеру (-Os)]{patterns/09_loops/memcpy/memcpy_GCC49_ARM64_Os.s.\LANG}
...
\lstinputlisting[caption=GCC 4.4.5 оптимизация по размеру (-Os) (IDA)]{patterns/09_loops/memcpy/memcpy_MIPS_Os_IDA.lst.\LANG}
