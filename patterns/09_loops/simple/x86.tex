...
\RU{И дажее более того, в \tracer можно собирать значения регистров по всем адресам внутри функции}
...
\TT{BPF} \RU{означает установить брякпойнт на функции}\EN{stands for set breakpoint on function}.
