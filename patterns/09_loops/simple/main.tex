...
\RU{после инициализации}\EN{after initializing} $i$\RU{, тело цикла не исполняется, а исполняется сразу
проверка условия $i$, а лишь затем исполняется тело цикла.}\EN{, the body of the loop will not be executed,
