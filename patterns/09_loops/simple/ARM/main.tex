...
\EN{Iteration counter $i$ will be stored in the \Reg{4} register.}
...
\RU{Следующая за ней инструкция}\EN{The next instruction} \TT{BLT} (\IT{Branch Less Than}) 
...
\RU{и произойдет выход из функции}\EN{and function execution will end}.
