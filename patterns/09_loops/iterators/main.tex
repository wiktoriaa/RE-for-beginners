...
\lstinputlisting[caption=\Optimizing GCC (Linaro) 4.9 ARM64,label=GCC_no_number_sign]{patterns/09_loops/iterators/ARM64_GCC_49_O3.s}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 \ForENRU MIPS (IDA)]{patterns/09_loops/iterators/MIPS_O3_IDA.lst}
\fi
