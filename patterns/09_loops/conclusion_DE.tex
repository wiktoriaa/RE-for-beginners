...
\lstinputlisting[caption=x86,style=customasm]{patterns/09_loops/skeleton_x86_2_9_optimized_DE.lst}

Das Inkrementieren kann in nicht optimiertem Code durch 3 Instruktionen
dargestellt werden:

\lstinputlisting[caption=x86,style=customasm]{patterns/09_loops/skeleton_x86_2_9_DE.lst}

Falls der Körper einer Schleife besonders kurz ist, kann ein Register als Zähler
verwendet werden:

\lstinputlisting[caption=x86,style=customasm]{patterns/09_loops/skeleton_x86_2_9_reg_DE.lst}

Einige Teile der Schleife können vom Compiler in unterschiedlichen Reihenfolgen
generiert werden:

\lstinputlisting[caption=x86,style=customasm]{patterns/09_loops/skeleton_x86_2_9_order_DE.lst}
...
\lstinputlisting[caption=x86,style=customasm]{patterns/09_loops/skeleton_x86_2_9_reorder_DE.lst}
...
　
\lstinputlisting[caption=x86,style=customasm]{patterns/09_loops/skeleton_x86_loop_DE.lst}
...
　
\lstinputlisting[caption=ARM,style=customasm]{patterns/09_loops/skeleton_ARM_DE.lst}
