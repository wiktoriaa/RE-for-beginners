...
\lstinputlisting[caption=MSVC 2010]{patterns/09_loops/9_1_\LANG_msvc.asm}
...
\lstinputlisting[caption=GCC 4.4.1]{patterns/09_loops/9_1_\LANG_gcc.asm}
...
\lstinputlisting[caption=GCC]{patterns/09_loops/9_2_gcc_\LANG.asm}
