...
\lstinputlisting[style=customasm]{patterns/19_SIMD/18_1_RU.asm}
...
\lstinputlisting[style=customasm]{patterns/19_SIMD/18_1_excerpt_RU.asm}
...
\lstinputlisting[style=customasm]{patterns/19_SIMD/18_2_gcc_O3.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1 x64,style=customasm]{patterns/19_SIMD/memcpy_GCC49_x64_O3_RU.s}
