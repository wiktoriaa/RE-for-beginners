...
\lstinputlisting{patterns/19_SIMD/18_1_RU.asm}
...
\lstinputlisting{patterns/19_SIMD/18_1_excerpt_RU.asm}
...
\subsectionold{Пример копирования блоков}
\label{vec_memcpy}
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1 x64]{patterns/19_SIMD/memcpy_GCC49_x64_O3_RU.s}
