...
\lstinputlisting[caption=\Optimizing MSVC 2013 x64]{patterns/28_string_trim/MSVC2013_x64_Ox.asm.\LANG}
...
\lstinputlisting[caption=\RU{Вставленная \strlen{} сгенерированная}\EN{Inlined \strlen{} by} MSVC 2013 x64]{patterns/28_string_trim/strlen_MSVC.asm.\LANG}
...
\lstinputlisting[caption=\RU{Моя версия}\EN{My version of} \strlen{}]{patterns/28_string_trim/my_strlen.asm.\LANG}
...
\lstinputlisting{patterns/28_string_trim/GCC491_x64_O0.asm.\LANG}
...
\lstinputlisting{patterns/28_string_trim/GCC491_x64_O3.asm.\LANG}
