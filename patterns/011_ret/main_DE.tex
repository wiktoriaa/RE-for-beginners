...
\lstinputlisting[caption=\Optimizing GCC/MSVC (\assemblyOutput),style=customasm]{patterns/011_ret/1.s}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode) Assembler-Ausgabe,style=customasm]{patterns/011_ret/1_Keil_ARM_O3.s}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (\assemblyOutput),style=customasm]{patterns/011_ret/MIPS.s}

\dots während \IDA Pseudonamen verwendet:

\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/011_ret/MIPS_IDA.lst}
