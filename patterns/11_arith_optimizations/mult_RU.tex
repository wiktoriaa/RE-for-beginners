\sectionold{Умножение}

\subsectionold{Умножение при помощи сложения}
...
\subsectionold{Умножение при помощи сдвигов}
...
\subsectionold{Умножение при помощи сдвигов, сложений и вычитаний}
...
\subsubsectionold{Алгоритм умножения Бута}
