...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/11_arith_optimizations/MIPS_SLL.lst}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/11_arith_optimizations/mult_shifts_MIPS_O3_IDA.lst}
