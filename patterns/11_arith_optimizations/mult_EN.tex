\sectionold{Multiplication}

\subsectionold{Multiplication using addition}
...
\subsectionold{Multiplication using shifting}
...
\subsectionold{Multiplication using shifting, subtracting, and adding}
...
\subsubsectionold{Booth's multiplication algorithm}
