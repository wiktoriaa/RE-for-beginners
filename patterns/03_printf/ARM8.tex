...
{such macros are created by \IDA in order to denote code accessing the stack}.
...
{Values of first 3 numbers (a, b, c) (1, 2, 3 respectively) are passed in the R1, R2 and R3
...
\EN{The} \RU{Инструкция }\TT{``ADD SP, SP, \#0x14''} \IFRU{возвращает \SP на прежнее место, 
...
rewritten with the execution of subsequent functions}.

\index{ARM!\Instructions!LDR}
\EN{The} \RU{Инструкция }\TT{``LDR PC, [SP+4+var\_4],\#4''} \IFRU{загружает в \PC сохраненное значение \LR из стека,
