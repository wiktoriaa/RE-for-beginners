...
\TT{B} вместо привычной нам \TT{BL}}\EN{This is optimized (\Othree) version for ARM mode and here we see \TT{B} as
...
\RU{Еще один похожий пример описан в секции}\EN{Another similar example was described in} 
``\SwitchCaseDefaultSectionName'' 
\RU{, здесь}\EN{section, here}~(\ref{jump_to_last_printf}).
