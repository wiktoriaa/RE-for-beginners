...
\centering
\ifdefined\ebook
\includegraphics{patterns/03_printf/x86/olly3_stack.png}
\else
\includegraphicsSmall{patterns/03_printf/x86/olly3_stack.png}
\fi
...
\begin{figure}[H]
\centering
\myincludegraphicsSmall{patterns/03_printf/x86/olly3_console.png}
