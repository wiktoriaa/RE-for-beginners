...
\EN{So the first instruction STP (Store Pair) saves \ac{FP} (X29) and \ac{LR} (X30) in the stack.}
...
\EN{Next, we see familiar \TT{ADRP}/\ADD instruction pair, which forms a pointer to the string.}
