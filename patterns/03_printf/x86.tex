...
\EN{A very important thing is that \ESP value is not changed. And argument values in stack too!}
...
\EN{Indeed, that's \IT{cdecl} calling convention, calling function doesn't return \ESP back.}
