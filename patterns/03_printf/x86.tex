...
\EN{A very important thing is that neither the \ESP value, nor the stack state is changed.}
...
\EN{Indeed, that's the \IT{cdecl} calling convention: calling a function doesn't clear arguments in stack}.
