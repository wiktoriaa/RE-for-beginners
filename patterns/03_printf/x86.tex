...
\\
\IFRU{Теперь}{Now the} \ac{PC} \IFRU{указывает на инструкцию}{points to the}
...
\IFRU{Потому что всё что выше указателя стека}{Because, everything above stack pointer} (\ac{SP}) 
