...
\lstinputlisting[style=customc]{patterns/061_pointers/global.c}

Это компилируется в:

\lstinputlisting[caption=\Optimizing MSVC 2010 (/Ob0),style=customasm]{patterns/061_pointers/global.asm}
...
\begin{figure}[H]
\centering
\myincludegraphics{patterns/061_pointers/olly_global1.png}
...
\begin{figure}[H]
\centering
\myincludegraphics{patterns/061_pointers/olly_global5.png}
...
\begin{figure}[H]
\centering
\myincludegraphics{patterns/061_pointers/olly_global2.png}
...
\begin{figure}[H]
\centering
\myincludegraphics{patterns/061_pointers/olly_global3.png}
...
\begin{figure}[H]
\centering
\myincludegraphics{patterns/061_pointers/olly_global4.png}
\caption{\olly: адреса глобальных переменных передаются в \printf}
\label{fig:pointers_olly_global_4}
\end{figure}

\subsection{Пример с локальными переменными}

Немного переделаем пример:

\lstinputlisting[caption=теперь переменные локальные,style=customc]{patterns/061_pointers/local_RU.c}

Код функции \ttfone не изменится.
Изменится только \main:

\lstinputlisting[caption=\Optimizing MSVC 2010 (/Ob0),style=customasm]{patterns/061_pointers/local.asm}
...
\begin{figure}[H]
\centering
\myincludegraphics{patterns/061_pointers/olly_stk1.png}
...
\begin{figure}[H]
\centering
\myincludegraphics{patterns/061_pointers/olly_stk2.png}
...
\begin{figure}[H]
\centering
\myincludegraphics{patterns/061_pointers/olly_stk3.png}
\caption{\olly: \ttfone заканчивает работу}
