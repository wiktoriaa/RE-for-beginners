...
\index{\olly}
\RU{Посмотрим это в}\EN{Let's see this in} \olly: \figname \ref{fig:pointers_olly_global_1}.
...
памяти}\EN{and seeing memory map}: \figname \ref{fig:pointers_olly_global_5}.
...
\EN{so far} \figname \ref{fig:pointers_olly_stk_2}.
