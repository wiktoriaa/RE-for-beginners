...
\lstinputlisting[caption=\Optimizing MSVC 2013 x64,style=customasm]{patterns/145_LCG/rand_MSVC_2013_x64_Ox_EN.asm}

GCC compiler generates mostly the same code.

\subsection{32-bit ARM}

\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),style=customasm]{patterns/145_LCG/rand.s_Keil_ARM_O3_EN.s}
