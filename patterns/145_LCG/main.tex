...
$0..32767$.}
\EN{The last AND operation is needed because by C-standard, \TT{my\_rand()} should return a value in 
the $0..32767$ range.}
...
\RU{Неоптимизирующая версия побольше}\EN{The non-optimized version is more verbose}:
...
(because we are workin with \Tint values here).}
...
\EN{The thread-safe version of the example is to be demonstrated later}: \ref{LCG_TLS}.
