...
\RU{Так что здесь две функции: одна используется для инициализации внутреннего состояния, и вторая
...
\RU{Последняя операция \q{И} нужно из-за стандарта Си, \TT{my\_rand()} должна возвращать значение в пределах
$0..32767$.}
