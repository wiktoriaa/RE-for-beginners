\chapter{\IFRU{Неверно дизассемблированный код}{Incorrectly disassembled code}}
...
\section{\IFRU{Дизассемблирование началось в неверном месте}{Disassembling started incorrectly} (x86)}
...
\section{\IFRU{Как выглядят случайные данные в дизассемблированном виде}{How random noise looks disassembled}?}
...
\section{\IFRU{Информационная энтропия среднестатистического кода}{Information entropy of average code}}
...
\subsection{ARM (\IFRU{режим ARM}{ARM mode})}
