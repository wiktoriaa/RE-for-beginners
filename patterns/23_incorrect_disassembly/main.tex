...
\index{ARM}
\lstinputlisting[caption=\randomNoise{} (ARM \RU{в режиме ARM}\EN{in ARM mode})]{patterns/23_incorrect_disassembly/ARM.asm}

\lstinputlisting[caption=\randomNoise{} (ARM \RU{в режиме Thumb}\EN{in Thumb mode})]{patterns/23_incorrect_disassembly/ARM_thumb.asm}
...
\subsection{ARM (\RU{режим ARM}\EN{ARM mode})}
