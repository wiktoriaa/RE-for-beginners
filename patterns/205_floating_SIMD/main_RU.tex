...
\chapterold{Работа с числами с плавающей запятой используя SIMD}
...
\clearpage
\sectionold{Передача чисел с плавающей запятой в аргументах}
...
\sectionold{Пример с сравнением}
...
\sectionold{Вычисление машинного эпсилона: x64 и SIMD}
