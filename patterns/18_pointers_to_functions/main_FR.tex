...
Ã son tour, elle appelle \TT{quicksort()}, oú notre fonction défini est appelée via
le pointeur passé:
...
Á chaque point d'arrêt, nous allons afficher le contenu de tous les registres\\
(\TT{info registers}).
