...
\lstinputlisting{patterns/18_pointers_to_functions/17_1.c}
...
\lstinputlisting[caption=\Optimizing MSVC 2010]{patterns/18_pointers_to_functions/17_2_msvc_Ox.asm}
