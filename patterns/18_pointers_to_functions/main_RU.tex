...
\chapterold{Указатели на функции}
...
\clearpage
\subsectionold{MSVC + tracer (code coverage)}
\myindex{tracer}
...
\subsectionold{GCC + GDB (с исходными кодами)}
\myindex{GDB}
...
\subsectionold{GCC + GDB (без исходных кодов)}
\myindex{GDB}
