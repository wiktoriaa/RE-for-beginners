...
\ac{RA} \RU{где находится место в ф-ции}\EN{, where the} 
...
\RU{Это был вызов ф-ции сравнения}\EN{That was a call to the comparison function}.

\clearpage
\RU{Вот также скриншот момента второго вызова ф-ции}\EN{Here is also a screenshot of the moment of the 
