...
объединить в список}
\EN{\Cpp STL just append ``next'' and ``previous'' pointers to your existing structure you wish to 
unite into a list}.
...
\RU{Хотя и стандарт \Cpp \cite{CPP11} не предлагает, как он должен быть реализован, реализации
MSVC и GCC прямолинейны и похожи друг на друга, так что этот исходный код для обоих}
\EN{Although \Cpp standard \cite{CPP11} does not offer how to implement it, 
