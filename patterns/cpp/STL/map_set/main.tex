...
\RU{Поле ``parent'' корневого узла указывает на ``настоящий'' корневой узел, который служит
как вершина дерева, и уже содержит информацию.}
\EN{``Parent'' field of the root node is pointing to the ``real'' root note, which serving
