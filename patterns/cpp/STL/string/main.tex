...
\RU{Здесь нет листингов на ассемблере, потому что проиллюстрировать внутренности std::string 
в \ac{MSVC} и GCC можно и без этого.}
\EN{There are no assembly listings, because std::string internals in \ac{MSVC} and GCC 
