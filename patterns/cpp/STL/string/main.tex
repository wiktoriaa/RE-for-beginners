...
\lstinputlisting[caption=\IFRU{пример для}{example for} MSVC]{patterns/cpp/STL/string/MSVC.cpp}
...
\lstinputlisting[caption=\IFRU{пример для}{example for} GCC]{patterns/cpp/STL/string/GCC.cpp}
