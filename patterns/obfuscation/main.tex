...
\lstinputlisting[caption=obfuscated code]{patterns/obfuscation/1_\LANG.asm}
...
\lstinputlisting{patterns/obfuscation/2_\LANG.asm}
...
\lstinputlisting{patterns/obfuscation/3_\LANG.asm}
