...
например, в \ac{PIC}, или в шелл-коде.}{By the way, it is a chance to work with the strings when it is not possible
...
\lstinputlisting{patterns/obfuscation/2_\IFRU{ru}{en}.c}
