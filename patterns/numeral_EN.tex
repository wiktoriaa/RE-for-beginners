...
\footnote{About numeric system evolution, see [\TAOCPvolII{}, 195--213.]}.
...
\subsectionold{Multi-precision arithmetics and radix}
...
In [\TAOCPvolII, 265] we can find the following idea: when you store multi-precision number in several bytes,
