...
\footnote{D'ailleurs, les instructions de taille fixe sont pratiques parce qu'il est possible de calculer l'instruction suivante (ou précédente) sans effort. Cette caracteristique sera discuté dans la section de l'opérateur switch()~(\myref{sec:SwitchARMLot}).}.
