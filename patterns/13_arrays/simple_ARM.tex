...
\IFRU{Указатель на элемент массива вычисляется так: \ac{SP} указывает на начало массива, \Reg{4} это $i$.}
{Here is how a pointer to array element is to be calculated: \ac{SP} pointing to array begin, \Reg{4} is $i$.}
