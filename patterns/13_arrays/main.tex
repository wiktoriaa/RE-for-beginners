...
Il est intéressant de noter que Hex-Rays remplace souvant la première par la seconde.
Il procède ainsi lorsque'il n'a aucune idée qu'il travaille avec un pointeur sur
