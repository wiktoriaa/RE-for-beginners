\subsection{\RU{Пример с трехмерным массивов}\EN{Threedimensional array example}}
...
\lstinputlisting[caption=\NonOptimizingXcode + \ThumbMode]{patterns/13_arrays/5_multidimensional/multi_Xcode_thumb_O0_\LANG.asm}
...
\lstinputlisting[caption=\OptimizingXcode + \ThumbMode]{patterns/13_arrays/5_multidimensional/multi_Xcode_thumb_O3_\LANG.asm}
