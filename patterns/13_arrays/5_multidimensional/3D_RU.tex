...
\lstinputlisting[caption=MSVC 2010,style=customasm]{patterns/13_arrays/5_multidimensional/multi_msvc_RU.asm}
...
\lstinputlisting[caption=GCC 4.4.1,style=customasm]{patterns/13_arrays/5_multidimensional/multi_gcc_RU.asm}
...
\lstinputlisting[caption=\NonOptimizingXcodeIV (\ThumbMode),style=customasm]{patterns/13_arrays/5_multidimensional/multi_Xcode_thumb_O0_RU.asm}
...
\lstinputlisting[caption=\OptimizingXcodeIV (\ThumbMode),style=customasm]{patterns/13_arrays/5_multidimensional/multi_Xcode_thumb_O3_RU.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/13_arrays/5_multidimensional/multi_MIPS_O3_IDA_RU.lst}
