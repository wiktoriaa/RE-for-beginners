...
\EN{For example, thit is how the elements of the $a[3][4]$ array will be placed in one-dimensional array of 12 cells:}
...
\EN{Here is how each cell of 3*4 array will be placed in memory:}
