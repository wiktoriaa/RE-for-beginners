...
\EN{Another example in this book is Minesweeper game: it's field is also two-dimensional array:}
\RU{Еще один пример в этой книге это игра ``Сапер'': её поле это тоже двухмерный массив:} \ref{minesweeper_winxp}.
