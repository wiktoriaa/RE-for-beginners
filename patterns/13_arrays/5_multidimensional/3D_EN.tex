\subsectionold{Three-dimensional array example}
...
\subsubsectionold{ARM + \NonOptimizingXcodeIV (\ThumbMode)}
...
\subsubsectionold{ARM + \OptimizingXcodeIV (\ThumbMode)}
