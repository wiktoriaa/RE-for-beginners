...
\lstinputlisting[caption=\Optimizing MSVC 2013 x64,style=customasm]{patterns/13_arrays/5_multidimensional/2D_as_1D_MSVC_2013_Ox_x64_EN.asm}

GCC also generates equivalent routines, but slightly different:

\lstinputlisting[caption=\Optimizing GCC 4.9 x64,style=customasm]{patterns/13_arrays/5_multidimensional/2D_as_1D_GCC49_x64_O3_EN.s}
