...
\lstinputlisting[caption=\NonOptimizing MSVC 2008,style=customasm]{patterns/13_arrays/2_BO/w_EN.asm}
...
\lstinputlisting[style=customasm]{patterns/13_arrays/2_BO/w_gcc.asm}
