...
\RU{И еще немного изучим разметку стека.}\EN{Let's study stack layout a bit more.}
...
\ESP now points to the \TT{\_i} variable in the local stack and after the execution of the next \TT{PUSH something},
\IT{something} will be appear next to \TT{\_i}.}
...
($20$ in decimal is $0x14$ in hexadecimal).
...
and $21$ iss stored there ($0x15$ in hexadecimal).
The CPU traps at address $0x15$,
