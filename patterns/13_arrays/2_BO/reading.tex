...
\RU{Итак, индексация массива ~--- это просто \IT{массив\lbrack{}индекс\rbrack}.  % TODO1 как-то плохо отображаются []
...
\RU{У меня оно при запуске выдало вот это:}\EN{When I run it, I get:}
