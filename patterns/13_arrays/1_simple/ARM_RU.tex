...
\lstinputlisting{patterns/13_arrays/1_simple/simple_Keil_ARM_O0_RU.asm}
...
Во втором цикле используется обратная инструкция \INS{LDR R2, [SP,R4,LSL\#2]}.
...
\lstinputlisting{patterns/13_arrays/1_simple/simple_Keil_thumb_O3_RU.asm}
...
\subsubsectionold{\NonOptimizing GCC 4.9.1 (ARM64)}

\lstinputlisting[caption=\NonOptimizing GCC 4.9.1 (ARM64)]{patterns/13_arrays/1_simple/ARM64_GCC491_O0_RU.s}
