...
\lstinputlisting[style=customasm]{patterns/13_arrays/1_simple/simple_Keil_ARM_O0_EN.asm}
...
\lstinputlisting[style=customasm]{patterns/13_arrays/1_simple/simple_Keil_thumb_O3_EN.asm}
...
\lstinputlisting[caption=\NonOptimizing GCC 4.9.1 (ARM64),style=customasm]{patterns/13_arrays/1_simple/ARM64_GCC491_O0_EN.s}
