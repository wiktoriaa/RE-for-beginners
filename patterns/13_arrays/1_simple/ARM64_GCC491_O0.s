...
; find a place of an array in local stack:
	add	x0, x29, 24
; load 32-bit integer from local stack and sign extend it:
	ldrsw	x1, [x29,108]
...
; by the way, the same place in the local stack is used for counter,
; because the same variable (i) is being used as counter.
	str	wzr, [x29,108]
	b	.L4
.L5:
