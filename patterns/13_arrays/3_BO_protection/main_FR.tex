\subsection{Méthode de protection contre les débordements de tampon}
...
nous voyons un appel à \TT{@\_RTC\_CheckStackVars@8} une fonction à la fin de la
fonction qui vérifie si le \q{canari} est correct.
...
comparée avce le \q{canari} correct dans \TT{gs:20}.
...
Á propos, en win32 le registre \TT{fs} joue le même rôle, pointant sur \ac{TIB}
...
dans \IT{arch/x86/include/asm/stackprotector.h} cette variable est décrite dans les commentaires.
