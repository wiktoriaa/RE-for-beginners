...
\EN{Canaries are very sensitive to mine gases, they become very agitated in case of danger, or even dead.}
...
\EN{ a function at the function end, checking for``canary'' correctness.}
