\sectionold{Buffer overflow protection methods}
...
\TT{@\_RTC\_CheckStackVars@8} a function at the end of the function that checks if the \q{canary} is correct.
...
\IT{arch/x86/include/asm/stackprotector.h} this variable is described in the comments.
