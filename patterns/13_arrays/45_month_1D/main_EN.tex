\sectionold{Array of pointers to strings}
...
\subsectionold{32-bit ARM}

\subsubsectionold{ARM in ARM mode}
...
\subsubsectionold{ARM in Thumb mode}
...
\subsubsectionold{Array overflow protection}
