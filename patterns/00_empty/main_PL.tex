...
Tu jest tylko jedna instrukcja \RET, która zwraca zarządzanie funkcji wywołującej \glslink{caller}{вызывающую ф-цию}.
...
która zwraca zarządzanie \glslink{caller}{вызывающую ф-цию}, skacząc pod adres w rejestrze \$31 (или \$RA).
