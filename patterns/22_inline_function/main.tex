...
\EN{Inlined code is when compiler, instead of placing call instruction to a small or tiny function,
...
\lstinputlisting[caption=\Optimizing GCC 4.8.1]{patterns/22_inline_function/1.s}
...
in modern times, these functions are automatically chosen by compiler.}
