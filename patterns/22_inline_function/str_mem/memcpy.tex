...
\lstinputlisting[caption=\Optimizing MSVC 2010]{patterns/22_inline_function/str_mem/memcpy_7_MSVC_2010_Ox.asm}

\lstinputlisting[caption=\Optimizing GCC 4.8.1]{patterns/22_inline_function/str_mem/memcpy_7_GCC_O3.s}
...
\index{Unrolled loop}
\RU{Кстати, это напоминает развернутые циклы}\EN{By the way, that reminds us unrolled loops}: 
...
\lstinputlisting[caption=\Optimizing MSVC 2010]{patterns/22_inline_function/str_mem/memcpy_128_MSVC_2010_Ox.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2010]{patterns/22_inline_function/str_mem/memcpy_123_MSVC_2010_Ox.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.8.1]{patterns/22_inline_function/str_mem/memcpy_GCC.s}
...
\index{SIMD}
\RU{Более сложные ф-ции копирования используют \ac{SIMD} и учитывают выравнивание в памяти.}
\EN{More complex copy functions uses \ac{SIMD} instructions and also take memory aligning 
into consideration.}
