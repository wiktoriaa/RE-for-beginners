...
\lstinputlisting[caption=GCC 4.8.1 -O3]{patterns/22_inline_function/str_mem/memcpy_7_GCC_O3.s}
...
\lstinputlisting[caption=GCC 4.8.1 -O3]{patterns/22_inline_function/str_mem/memcpy_GCC.s}
