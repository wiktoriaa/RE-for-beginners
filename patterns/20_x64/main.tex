...
\item
\RU{В win64 передача всех параметров немного иная, это немного похоже на fastcall~(\myref{fastcall}).
...
\EN{In Win64, the function calling convention is slightly different, somewhat resembling fastcall~(\myref{fastcall}).
