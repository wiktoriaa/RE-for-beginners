...
so, for convenience it shows the last ORI instruction as the LI pseudo instruction,
...
\EN{The GCC assembly output has the LI pseudo instruction, but in fact, LUI (\q{Load Upper Immediate}) is there,
