...
\RU{Я скомпилировал пример из}\EN{I compiled the example from} \q{\HelloWorldSectionName} 
...
\EN{As an example, let's try to disassemble the BL instruction manually.}\\
