...
\EN{As of x86-64, all registers were extended to 64-bit and now have an \TT{R-} prefix}.
\index{fastcall}
...
\EN{However, for backward compatibility, it is still possible to access 32-bit parts, using the \TT{E-} prefix}.
