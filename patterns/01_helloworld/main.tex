...
\section{\EN{Conclusion}\RU{Вывод}}

\RU{Основная разница между кода x86 и x64 в том, что указатель на строку теперь 64-битный.}
\EN{The main difference between x86 and x64 code is that pointer to the string is now 64-bit.}
