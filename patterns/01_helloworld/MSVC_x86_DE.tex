...
Da der Compiler jedoch irgendwie auf diese Zeichenkette zugreifen muss, definiert er den internten Namen \TT{\$SG3830}.
...
Mehr über \CCpp-Zeichenketten ist im Abschnitt \myref{C_strings}.
...
Einige Compiler erzeugen \INS{SUB EAX, EAX}, was \IT{Subtrahiere der Wert in} \EAX \IT{vom Wert in} \EAX bedeutet.
In jedem Fall erzeugt dies einen Wert von Null.

\myindex{x86!\Instructions!RET}
Die letzte Anweisung \RET gibt die Ausführungs-Kontrolle wieder an die aufrufende Funktion \gls{caller}.
