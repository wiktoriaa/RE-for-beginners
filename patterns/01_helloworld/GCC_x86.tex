...
In addition, in the function prologue, we see \TT{AND ESP, 0FFFFFFF0h}~---this 
...
\EN{There are many macros (beginning with dot). These are not interesting for us at the moment.}
