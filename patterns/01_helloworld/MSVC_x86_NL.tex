...
De string \TT{hello, world} in \CCpp is van het type \TT{const char[]}\cite[p176, 7.3.2]{TCPPPL}, maar heeft geen eigen naam.
...
\begin{lstlisting}[caption=\oracle 10.2 Linux (app.o bestand)]
