...
\EN{When the \printf function returns flow control to the \main function, string address (or a pointer to it) is still on stack.}
...
\footnote{\url{http://go.yurichev.com/17118}}
