...
Jeśli nasz przykład jest skompilowany w MSVC2013 z opcją \TT{\textbackslash{}MD}
...
Możemy naprzykład spróbować \glslink{increment}{inkrementować} adres:
...
Jeśli się zmieni adres na \TT{0x400260}, to wyprintuje się linia \q{GNU}.
