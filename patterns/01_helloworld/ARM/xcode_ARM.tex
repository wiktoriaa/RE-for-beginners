...
\EN{\IT{Almost}, because the two functions will produce the same result only in case the string does not contain printf format identifiers starting with \IT{\%}. In case it does the effect of these two functions would be different}
\footnote{
