...
saves two registers in the stack simultaneously: \RegX{29} \InENRU \RegX{30}.
...
About the difference between \IT{post-index} \AndENRU \IT{pre-index} 
...
The second instruction copies \ac{SP} \InENRU \RegX{29} (\OrENRU \ac{FP}).
This is done to set up the function stack frame.

\label{pointers_ADRP_and_ADD}
\myindex{ARM!\Instructions!ADRP/ADD pair}
\TT{ADRP} \AndENRU \ADD instructions are used to fill the 
