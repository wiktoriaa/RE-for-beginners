...
\RU{Первая инструкция}\EN{The first instruction} (\TT{ADRP}) \EN{writes the address of the 4Kb page, where the string is
located, into \RegX{0}}\RU{записывает в \RegX{0} адрес 4-килобайтной страницы где находится строка}, 
% The Russian text says 4 kilobytes,
% but the English says 4Kb, which means 4 kilobits. Should Kb be changed to KB?
