...
\EN{So, in order to reduce the time the \ac{OS} loader needs for completing this procedure, it will be good idea if it writes the address of each symbol only once to a dedicated place}.
