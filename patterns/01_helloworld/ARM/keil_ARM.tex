...
наш код}
\EN{This difference (offset) is always to be the same,
no matter at what address our code is loaded by the \ac{OS}}.
...
\EN{That is a difference between ``pure'' \ac{RISC}-processors like ARM and \ac{CISC}-processors like x86,
