...
\RU{Так что регистр \$GP в прологе функции выставляется в середину этой области.}
...
\RU{Адрес функции \puts загружается в \$25 используя инструкцию LW (``Load Word'').}
...
\RU{Если бы это была \gls{leaf function}, тогда можно было бы избавиться от пролога и эпилога функции,
например:}
