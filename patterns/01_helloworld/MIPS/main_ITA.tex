...
\subsectionold{Qualche parola sul \q{global pointer}}
\label{MIPS_GP}
...
\subsectionold{\NonOptimizing GCC}
...
\subsectionold{Ruolo dello the stack frame in questo esempio}
...
\subsectionold{\Optimizing GCC: carichiamolo in GDB}
