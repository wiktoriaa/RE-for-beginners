...
used vector registers is passed in \EAX by the standard}:
\q{with variable arguments [\EAX] passes information about the number of vector registers used} \cite{SysVABI}.
