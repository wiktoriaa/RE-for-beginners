\section{\IFRU{Пример SYSTEMTIME}{SYSTEMTIME example}}
...
{16 bytes are allocated for this structure in local stack~---that is exactly \TT{sizeof(WORD)*8}
...
переставляться местами, и т.д}{Also structure fields may be changed by developers, swapped, etc}.
