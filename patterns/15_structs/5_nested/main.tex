...
\lstinputlisting[caption=MSVC 2010 /Ox /Ob0]{patterns/15_structs/5_nested/nested_msvc.asm}
...
\TT{outer\_struct} \RU{в памяти}\EN{in memory}: \figname \ref{fig:nested_olly}.
