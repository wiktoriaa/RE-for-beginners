...
\RU{Компилятор немного поворчит:}\EN{The compiler will grumble a bit:}
...
переставляться местами, и т.д}\EN{Also the structure fields may be changed by developers, swapped, etc}.
