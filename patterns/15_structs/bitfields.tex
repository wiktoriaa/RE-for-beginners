...
\begin{figure}[H]
\centering
\includegraphics[scale=0.66]{patterns/15_structs/500px-Float_example.png}
...
\lstinputlisting[caption=\NonOptimizing MSVC 2008]{patterns/15_structs/float_msvc_\IFRU{ru}{en}.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.1]{patterns/15_structs/float_gcc_O3_\IFRU{ru}{en}.asm}
