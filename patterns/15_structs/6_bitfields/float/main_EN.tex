\subsectionold{\WorkingWithFloatAsWithStructSubSubSectionName}
...
\lstinputlisting{patterns/15_structs/6_bitfields/float/float_EN.c}
...
\lstinputlisting[caption=\NonOptimizing MSVC 2008]{patterns/15_structs/6_bitfields/float/float_msvc_EN.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.1]{patterns/15_structs/6_bitfields/float/float_gcc_O3_EN.asm}
