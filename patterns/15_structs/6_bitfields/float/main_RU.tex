...
\lstinputlisting[caption=\NonOptimizing MSVC 2008,style=customasm]{patterns/15_structs/6_bitfields/float/float_msvc_RU.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.1,style=customasm]{patterns/15_structs/6_bitfields/float/float_gcc_O3_RU.asm}
