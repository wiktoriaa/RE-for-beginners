...
\EAX из массива \TT{b[]}.}
\EN{After \CPUID fills \EAX/\EBX/\ECX/\EDX, these registers will be written in the \TT{b[]} array.
...
\EN{The \ANDIns instruction clears the unneeded bits \IT{on the left}, or, in other words, 
