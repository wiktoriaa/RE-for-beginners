...
\EN{By looking at our listing \ref{src:struct_packing_4}, we can see that the first and third fields
...
\EN{The remaiing 3 bytes of the 32-bit words are not being modified in memory!}
