...
\EN{The structure is copied, because it's unknown, will the \ttf{} function modify structure or not.
...
\EN{As we can see, each field's address is aligned on a 4-bytes boundary.
