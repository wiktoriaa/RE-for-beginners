...
\lstinputlisting[caption=\OptimizingKeilVI (\ThumbMode),style=customasm]{patterns/15_structs/4_packing/packing_Keil_thumb.asm}
...
\lstinputlisting[caption=\OptimizingXcodeIV (\ThumbTwoMode),style=customasm]{patterns/15_structs/4_packing/packing_Xcode_thumb.asm}
