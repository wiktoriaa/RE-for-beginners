...
\EN{After stack allocation, the \gls{stack pointer} points at the end of stack.}
...
сторону увеличения.}
\EN{Besides support for descending stacks, ARM has also support for ascending stacks.} \\
...
т.е. в сторону увеличения адресов}\EN{Intuitively, we might think that the strack grow upwards, i.e. towards
...
для \glslink{heap}{кучи} и стека}\EN{When the computers were big and occupied a whole room, 
