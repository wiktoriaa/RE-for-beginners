...
\IFRU{Технически, это просто блок памяти в памяти процесса + регистр \ESP или \RSP в x86 или x64, либо \ac{SP} в ARM, который указывает где-то в пределах этого блока.}
...
\section{\IFRU{Почему стек растет в обратную сторону?}{Why does the stack grow backward?}}
...
\section{\IFRU{Для чего используется стек?}{What is the stack used for?}}
...
\section{\IFRU{Разметка типичного стека}{Typical stack layout}}
