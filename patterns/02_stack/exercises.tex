...
\EN{If we compile this piece of code in MSVC and run it, three numbers will be printed.
Where do they come from?
Where will they come from if you compile it in MSVC with optimization (\Ox)?}
\RU{Почему в GCC ситуация совсем иная}\EN{Why is the situation completely different in GCC}?
