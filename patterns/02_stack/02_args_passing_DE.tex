...
\begin{lstlisting}
mov  dx, msg      ; Adresse der Naricht % address of message 
mov  ah, 9        ; 9 bedeutet ``print string'' % 9 mean "print string" function
int  21h          ; DOS "syscall"

mov  ah, 4ch      ; ``Terminiere Programm'' Funktion %"terminate program" function
int  21h          ; DOS "syscall"
