\subsectionold{x86: alloca() function}
\label{alloca}
...
\subsubsectionold{GCC + \IntelSyntax}
...
\subsubsectionold{GCC + \ATTSyntax}
...
By the way, \INS{movl \$3, 20(\%esp)} corresponds to \INS{mov DWORD PTR [esp+20], 3} in Intel-syntax.
