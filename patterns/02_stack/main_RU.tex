...
\sectionold{Почему стек растет в обратную сторону?}
...
Причина, почему стек растет назад, вероятно, историческая.
...
\sectionold{Для чего используется стек?}
...
\subsectionold{Автоматическое освобождение данных в стеке}
