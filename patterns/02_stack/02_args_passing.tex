...
\EN{See also the section about other calling conventions}~(\myref{sec:callingconventions}).
...
passing control to subroutine. Knuth writes this method was particularly convenient on IBM System/360.}}.
