...
\RU{Тем не менее, если некая функция не вызывает никаких других функций, в терминологии ARM она называется}
...
\EN{Some examples of leaf functions:}\RU{Некоторые примеры таких функций:} \listingname 
