...
(первый), мы увидим, что \EBP указывает на \glslink{stack frame}{фрейм стека}. Я выделил его красным прямоугольником.}
...
``RETURN from'' \AndENRU ``Arg1 = \dots'', \etc{}.
...
\RU{Поэтому \olly отметил элементы ``Arg'' как члены другого фрейма стека.}
