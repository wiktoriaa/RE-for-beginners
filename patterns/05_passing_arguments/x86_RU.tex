...
\lstinputlisting[label=src:passing_arguments_ex_MSVC_cdecl,caption=MSVC 2010 Express,style=customasm]{patterns/05_passing_arguments/msvc_RU.asm}
...
\lstinputlisting[caption=GCC 4.4.1,style=customasm]{patterns/05_passing_arguments/gcc_RU.asm}
