...
\lstinputlisting[caption=\Optimizing MSVC 2012 x64,style=customasm]{patterns/05_passing_arguments/x64_MSVC_Ox_EN.asm}
...
\lstinputlisting[caption=MSVC 2012 x64,style=customasm]{patterns/05_passing_arguments/x64_MSVC_IDA_EN.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.6 x64,style=customasm]{patterns/05_passing_arguments/x64_GCC_O3_EN.s}

\NonOptimizing GCC:

\lstinputlisting[caption=GCC 4.4.6 x64,style=customasm]{patterns/05_passing_arguments/x64_GCC_EN.s}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.6 x64,style=customasm]{patterns/05_passing_arguments/ex64_GCC_O3_IDA_EN.asm}
