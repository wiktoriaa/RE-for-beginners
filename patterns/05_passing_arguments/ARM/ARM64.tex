...
\EN{Function \ttf{} is just the same, but whole 64-bit X-registers are now used.}
...
\EN{Long 64-bit values are loaded into registers by parts, I described it also here}: \ref{ARM_big_constants_loading}.
