...
\RU{Первая инструкция \TT{MULS} умножает \Reg{0} на \Reg{1}, оставляя результат в \Reg{0}.}
\EN{First the \TT{MULS} instruction multiplies \Reg{0} by \Reg{1}, leaving the result in register \Reg{0}.}
