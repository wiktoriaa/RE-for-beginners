...
\EN{The }\RU{Функция }\TT{f}\RU{, как видно, использует три первых регистра (\Reg{0}-\Reg{2}) как аргументы.}
...
\EN{This can be necessary since, as we can see, function \TT{f} is not aware from what kind of code it may be
called, ARM or thumb.}
