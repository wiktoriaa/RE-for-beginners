...
\EN{And here is the \TT{f} function compiled by the Keil compiler in full optimization mode} (\Othree).
...
\EN{Te \MOV instruction was optimized out (or reduced) and now \TT{MLA} uses all 
