...
so here we see a jump to \puts (JR: ``Jump Register'') instead of ``jump and link''.}
\RU{Мы говорили об этом раннее}\EN{We talked about this earlier}: \myref{JMP_instead_of_RET}.
