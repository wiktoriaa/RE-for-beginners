...
\RU{Функция всегда заканчивается вызовом \puts, так что здесь мы видим переход на \puts (JR: ``Jump Register'')
...
\RU{Это}\EN{This is} ``load delay slot'': \RU{ещё один \IT{delay slot} в MIPS}\EN{another \IT{delay slot} in MIPS}.
