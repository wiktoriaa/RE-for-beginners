include(`commons.m4')$SG2798	DB	'1, 2, 7, 10', 0aH, 00H
...
$LN1@f:
	...
	jmp	DWORD PTR __imp__printf
	npad	2 ; _EN(`align')_RU(`выровнять таблицу') $LN11@f _EN(`table on 16-byte boundary')_RU(`по 16-байтной границе')
$LN11@f:
	DD	$LN5@f ; _print '1, 2, 7, 10'
	DD	$LN4@f ; _print '3, 4, 5'
	DD	$LN3@f ; _print '8, 9, 21'
	DD	$LN2@f ; _print '22'
	DD	$LN1@f ; _print 'default'
$LN10@f:
	DB	0 ; a=1
	DB	0 ; a=2
	DB	1 ; a=3
