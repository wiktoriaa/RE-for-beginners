...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),,style=customasm]{patterns/08_switch/2_lot/lot_ARM_ARM_O3.asm}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ThumbMode),style=customasm]{patterns/08_switch/2_lot/lot_ARM_thumb_O3.asm}
