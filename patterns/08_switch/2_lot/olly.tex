...
\RU{Кстати, я щелкнул по}\EN{Here I've clicked} ``Follow in Dump'' $\rightarrow$ ``Address constant'', 
...
\RU{Кстати, можно также щелкнуть}\EN{It's also possible to click} ``Follow in Dump'' $\rightarrow$ 
``Memory address'' \AndENRU \olly 
