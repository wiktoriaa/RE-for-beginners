...
\lstinputlisting[caption=MSVC 2010]{patterns/08_switch/lot_msvc.asm}
...
\RU{Эта таблица иногда называется}\EN{This table sometimes called} \IT{jumptable}.
...
\begin{figure}[H]
\centering
\includegraphics[scale=\FigScale]{patterns/08_switch/lot_olly1.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=\FigScale]{patterns/08_switch/lot_olly2.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=\FigScale]{patterns/08_switch/lot_olly3.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=\FigScale]{patterns/08_switch/lot_olly4.png}
...
\lstinputlisting[caption=GCC 4.4.1]{patterns/08_switch/lot_gcc.asm}
