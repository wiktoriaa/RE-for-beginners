...
\lstinputlisting[caption=Keil 5.03 (\ARMMode) -O3,label=ARM_leaf_example8]{patterns/10_strlen/exercises/toupper_ARM.s}

\lstinputlisting[caption=Keil 5.03 (\ThumbMode) -O3,label=ARM_leaf_example9]{patterns/10_strlen/exercises/toupper_thumb.s}
