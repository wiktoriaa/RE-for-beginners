\subsection{Calculde l'epsilon de la machine}
...
précision(\Tfloat).
L' \IT{union} permet ici d'accèder au nombre IEEE 754 comme à un entier normal.
Lui ajouter 1 ajoute en fait 1 à la partie \IT{mantisse} du nombre, toutefois,
