...
\chapter{Una breve introduzione alla CPU}
...
\section{Несколько слов о разнице между \ac{ISA}}
...
\iffalse
% another translation
\chapter{Uma breve introdução à CPU}
...
\section{\ES{Algunas palabras sobre diferentes \ac{ISA}s}}
