...
I could quickly understand what was in the original C code when I looked at the produced x86 code. 
...
\EN{A practicing reverse engineer will usually encounter both versions,
...
\section{\RU{Несколько слов о разнице между \ac{ISA}}\EN{A couple of words about difference between \ac{ISA}}}
