...
% chapters
\EN{\input{patterns_opt_dbg_EN}}
\ES{\input{patterns_opt_dbg_ES}}
\ITA{\input{patterns_opt_dbg_ITA}}
\PTBR{\input{patterns_opt_dbg_PTBR}}
\RU{\input{patterns_opt_dbg_RU}}
\TH{\input{patterns_opt_dbg_TH}}
...
% sections:
\EN{\input{intro_CPU_ISA_EN}}
\ES{\input{intro_CPU_ISA_ES}}
\ITA{\input{intro_CPU_ISA_ITA}}
\PTBR{\input{intro_CPU_ISA_PTBR}}
\RU{\input{intro_CPU_ISA_RU}}
