...
\EN{Sometimes, I use really ancient compilers, in order to get shortest (or simplest) possible
code snippet.}
...
\EN{So you can try to take any assembly code from this book and try to make it shorter.}
\RU{Но не забывайте о тестировании своих результатов!}
\EN{But please also do not forget about testing your results!}
\fi
