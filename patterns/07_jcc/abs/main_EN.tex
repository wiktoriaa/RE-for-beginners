...
\lstinputlisting[caption=\Optimizing MSVC 2012 x64,style=customasm]{patterns/07_jcc/abs/abs_MSVC2012_Ox_x64_EN.asm}

GCC 4.9 does mostly the same.

\subsubsection{\OptimizingKeilVI: \ThumbMode}

\lstinputlisting[caption=\OptimizingKeilVI: \ThumbMode,style=customasm]{patterns/07_jcc/abs/abs_Keil_thumb_O3_EN.s}
...
\lstinputlisting[caption=\OptimizingKeilVI: \ARMMode,style=customasm]{patterns/07_jcc/abs/abs_Keil_ARM_O3_EN.s}
...
\lstinputlisting[caption=\Optimizing GCC 4.9 (ARM64),style=customasm]{patterns/07_jcc/abs/abs_GCC49_ARM64_O0_EN.s}

\subsubsection{MIPS}

\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/07_jcc/abs/MIPS_O3_IDA_EN.lst}
