...
\lstinputlisting[caption=\NonOptimizing MSVC 2010,style=customasm]{patterns/07_jcc/simple/signed_MSVC.asm}
...
\lstinputlisting[caption=GCC,style=customasm]{patterns/07_jcc/simple/unsigned_MSVC.asm}
...
\lstinputlisting[caption=\main,style=customasm]{patterns/07_jcc/simple/main_MSVC.asm}
...
\lstinputlisting[caption=GCC 4.8.1 f\_signed(),style=customasm]{patterns/07_jcc/simple/GCC_O3_signed.asm}
...
\lstinputlisting[caption=GCC 4.8.1 f\_unsigned(),style=customasm]{patterns/07_jcc/simple/GCC_O3_unsigned_EN.asm}
