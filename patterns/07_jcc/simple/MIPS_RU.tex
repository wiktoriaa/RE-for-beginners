...
\lstinputlisting[caption=\NonOptimizing GCC 4.4.5 (IDA),style=customasm]{patterns/07_jcc/simple/O0_MIPS_signed_IDA_RU.lst}
...
\lstinputlisting[caption=\NonOptimizing GCC 4.4.5 (IDA),style=customasm]{patterns/07_jcc/simple/O0_MIPS_unsigned_IDA.lst}
