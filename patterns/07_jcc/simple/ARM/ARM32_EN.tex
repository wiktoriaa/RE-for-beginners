...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),style=customasm]{patterns/07_jcc/simple/ARM/ARM_O3_signed.asm}
...
and is triggered only if the result of the comparison has been the same (\IT{Greater Than}). 
...
\lstinputlisting[caption=\main,style=customasm]{patterns/07_jcc/simple/ARM/ARM_O3_main.asm}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ThumbMode),style=customasm]{patterns/07_jcc/simple/ARM/ARM_thumb_signed.asm}
