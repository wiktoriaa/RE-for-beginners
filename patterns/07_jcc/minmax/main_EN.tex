...
\lstinputlisting[caption=\NonOptimizing MSVC 2013,style=customasm]{patterns/07_jcc/minmax/minmax_MSVC_2013_EN.asm}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ThumbMode),style=customasm]{patterns/07_jcc/minmax/minmax_Keil_Thumb_O3_EN.s}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),style=customasm]{patterns/07_jcc/minmax/minmax_Keil_ARM_O3_EN.s}
...
\lstinputlisting[caption=\Optimizing MSVC 2013,style=customasm]{patterns/07_jcc/minmax/minmax_GCC481_O3_EN.s}
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1 x64,style=customasm]{patterns/07_jcc/minmax/minmax64_GCC_49_x64_O3_EN.s}
...
\lstinputlisting[caption=\Optimizing GCC 4.9.1 ARM64,style=customasm]{patterns/07_jcc/minmax/minmax64_GCC_49_ARM64_O3_EN.s}

\subsubsection{MIPS}

Unfortunately, GCC 4.4.5 for MIPS is not that good:

\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/07_jcc/minmax/minmax_MIPS_O3_IDA_EN.lst}
