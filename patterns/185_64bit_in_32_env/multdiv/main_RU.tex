...
\lstinputlisting[caption=\Optimizing MSVC 2013 /Ob1,style=customasm]{patterns/185_64bit_in_32_env/multdiv/2_MSVC_RU.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.8.1 -fno-inline,style=customasm]{patterns/185_64bit_in_32_env/multdiv/2_GCC_RU.asm}
...
\lstinputlisting[caption=\OptimizingKeilVI (\ThumbMode),style=customasm]{patterns/185_64bit_in_32_env/multdiv/Keil_thumb_O3.s}

Keil для режима ARM, тем не менее, может сгенерировать код для умножения 64-битных чисел:


\lstinputlisting[caption=\OptimizingKeilVI (\ARMMode),style=customasm]{patterns/185_64bit_in_32_env/multdiv/Keil_ARM_O3.s}
...
\lstinputlisting[caption=\Optimizing GCC 4.4.5 (IDA),style=customasm]{patterns/185_64bit_in_32_env/multdiv/MIPS_O3_IDA.lst}
