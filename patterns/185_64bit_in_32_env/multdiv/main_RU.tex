\sectionold{Умножение, деление}

\lstinputlisting{patterns/185_64bit_in_32_env/multdiv/2.c}

\subsectionold{x86}

\lstinputlisting[caption=\Optimizing MSVC 2013 /Ob1]{patterns/185_64bit_in_32_env/multdiv/2_MSVC_RU.asm}
...
\lstinputlisting[caption=\Optimizing GCC 4.8.1 -fno-inline]{patterns/185_64bit_in_32_env/multdiv/2_GCC_RU.asm}
