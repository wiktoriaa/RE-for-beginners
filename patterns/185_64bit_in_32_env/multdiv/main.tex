...
делающих это}\EN{Multiplication and division is more complex operation, so usually, the compiler embeds calls to
...
\EN{can generate 64-bit multiplication code, but have to call library routine for 64-bit division:}
...
\EN{There are a lot of \ac{NOP}s, they are probably delay slots filled after multiplication instruction (it's slow
