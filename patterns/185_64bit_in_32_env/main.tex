\section{\IFRU{64-битные значения в 32-битной среде}{64-bit values in 32-bit environment}}
...
\subsection{\IFRU{Передача аргументов, сложение, вычитание}{Arguments passing, addition, subtraction}}
...
\subsection{\IFRU{Умножение, деление}{Multiplication, division}}
...
\subsection{\IFRU{Сдвиг вправо}{Shifting right}}
...
\subsection{\IFRU{Конвертирование 32-битного значения в 64-битное}{Converting of 32-bit value into 64-bit one}}
