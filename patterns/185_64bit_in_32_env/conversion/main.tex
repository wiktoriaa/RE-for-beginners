...
\EN{But this is not appropriate for signed data types: the sign should be copied into the higher part of the resulting number}.
...
\EN{So after ``ASR r1,r0,\#31'', R1 will contain 0xFFFFFFFF if the input value was negative
and 0 otherwise.}
