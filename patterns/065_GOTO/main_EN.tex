...
\lstinputlisting[caption=MSVC 2012,style=customasm]{patterns/065_GOTO/MSVC_goto.asm}
...
\lstinputlisting[caption=\Optimizing MSVC 2012,style=customasm]{patterns/065_GOTO/MSVC_goto_Ox.asm}
