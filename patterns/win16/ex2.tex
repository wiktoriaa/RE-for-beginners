...
\EN{Couple important things here: \TT{PASCAL} calling convention dictates passing the last argument first} 
(\TT{MB\_YESNOCANCEL}), \RU{а самый первый аргмент\EMDASH{}последним}\EN{and the first argument\EMDASH{}last} (NULL).
