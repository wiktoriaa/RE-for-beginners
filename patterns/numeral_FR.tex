...
Dans \InSqBrackets{\TAOCPvolII, 265} vous pouvez trouver l'idée suivante: quand vous enregistrez un nombre multiprécision dans plusieurs octets. Tout le nombre peut être représenté une base de $2^8=256$, et chaque chiffre est associé à l'octet correspondant.
