...
\IFRU
{Как я уже упоминал, использовать \scanf в наше время это слегка старомодно. 
...
\lstinputlisting{scanf/retval_check.c}
...
\lstinputlisting{scanf/retval_check_MSVC.asm}
...
\input{scanf/checking_retval_ARM}
