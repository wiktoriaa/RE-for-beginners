...
\IFRU{Как можно увидеть в истории коммитов, я делаю много мелких изменений}
{As you may see in commit history, I do a lot of small changes}:
...
\IFRU{Без релизов (и дедлайнов) вообще, а постепенное разработка}
...
{Of course, it is not very comfortably for readers, but all I can offer is a \ChangeLogURL{} 
file serving as
``what's new'' section}.
...
\IFRU{Роман Некон}{Roman Nekon}, \IFRU{аноним}{anonymous}.
