...
\RU{здесь более 500 страниц}\EN{there are more than 500 pages}.
\RU{Здесь $\approx 300$ \TeX-файлов, $\approx 90$ исходников на \CCpp, $\approx 350$ различных листингов}
\EN{There are $\approx 300$ \TeX-files, $\approx 90$ \CCpp source codes, $\approx 350$ various listings}.
...
\EN{Ways to donate are available on the page:} \url{http://yurichev.com/donate.html}
...
9 * \RU{аноним}\EN{anonymous}, 2 * \RU{Олег Выговский}\EN{Oleg Vygovsky}, Daniel Bilar, James Truscott,
...
\RU{Сергей Лукьянов}\EN{Sergey Lukianov}, Ludvig Gislason, Gérard Labadie.
