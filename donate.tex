...
\RU{и всегда будет оставаться таковой}\EN{and it will stay so forever}.
...
\RU{здесь более 900 страниц}\EN{there are more than 900 pages}.
...
\RU{Так что книга, наверное, будет в виде ``rolling release'', 
как говорят о дистрибутивах Linux вроде Gentoo.}
\EN{So the book probably will be a ``rolling release'' as they say about Linux distros like Gentoo.}
