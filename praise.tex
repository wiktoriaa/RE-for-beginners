...
\item ``... excellent and free''\footnote{\href{http://go.yurichev.com/17096}{twitter.com/petefinnigan/status/400551705797869568}} Pete Finnigan, \RU{гуру по безопасности }\oracle\EN{ security guru}.
...
\item ``Dennis @Yurichev has published an impressive (and free!) book on reverse engineering''\footnote{\href{http://go.yurichev.com/17098}{twitter.com/TanelPoder/status/524668104065159169}} Tanel Poder, \EN{Oracle RDBMS performance tuning expert}\RU{эксперт по настройке производительности Oracle RDBMS}.
