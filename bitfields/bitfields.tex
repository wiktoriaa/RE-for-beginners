...
\caption{\IFRU{Как работает инструкция \SHL (иллюстрация взята из wikipedia)}
...
\caption{\IFRU{Как работает инструкция \SHR (иллюстрация взята из wikipedia)}
{How \SHR instruction works (illustration taken from wikipedia)}}
\end{figure}
