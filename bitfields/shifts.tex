...
\lstinputlisting{bitfields/shifts.c}
...
\lstinputlisting{\IFRU{bitfields/shifts_MSVC_ru.asm}{bitfields/shifts_MSVC_en.asm}}
...
\lstinputlisting{bitfields/shifts_gcc.asm}
