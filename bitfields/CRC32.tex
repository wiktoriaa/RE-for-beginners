...
\lstinputlisting{bitfields/CRC.c}
...
\lstinputlisting{\IFRU{bitfields/CRC_2_ru.asm}{bitfields/CRC_2_en.asm}}

\IFRU{Попробуем то же самое в GCC 4.4.1 с опцией \Othree:}
{Let's try the same in GCC 4.4.1 with \Othree option:}

\lstinputlisting{\IFRU{bitfields/CRC_gcc_O3_ru.asm}{bitfields/CRC_gcc_O3_en.asm}}
