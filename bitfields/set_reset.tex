...
\lstinputlisting{bitfields/set_reset.c}

\IFRU{Имеем в итоге}{We got} (MSVC 2010):

\lstinputlisting{bitfields/set_reset_msvc.asm}
...
\lstinputlisting{bitfields/set_reset_msvc_Ox.asm}

\IFRU{Попробуем GCC 4.4.1 без оптимизации:}{Let's try GCC 4.4.1 without optimization:}

\lstinputlisting{bitfields/set_reset_gcc.asm}
...
\lstinputlisting{bitfields/set_reset_gcc_O3.asm}
...
\lstinputlisting{bitfields/set_reset_gcc_O3_regparm3.asm}
