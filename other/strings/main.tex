...
\begin{figure}[H]
\centering
\includegraphics[scale=0.66]{other/strings/multilang_sampler.png}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.66]{other/strings/multilang_sampler_UTF8.png}
\caption{FAR: UTF-8}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.66]{other/strings/russian_UTF16.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.66]{other/strings/multilang_sampler_UTF16.png}
