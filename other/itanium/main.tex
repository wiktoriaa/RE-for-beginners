...
{While \ac{OOE} CPUs decides how to rearrange instructions and execute them in parallel,
...
\lstinputlisting[caption=Linux Kernel 3.2.0.4 \IFRU{для}{for} Itanium 2 (McKinley)]{other/itanium/ia64_linux_3.2.0.4_mckinley.lst}
...
{In practice, Itanium 2 may execute 2 bundles at once, resulting execution of 6 instructions at once}.
...
инструкции вручную}
{Manual assembly programming is tedious job as well: programmer should group instructions manually}.
