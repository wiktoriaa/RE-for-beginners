\section{Statistiques sur le nombre d'arguments d'une fonction}
\label{args_stat}
...
(parce qu'elles utilise la convention d'appel \IT{stdcall} et qu'il est donc facile de retrouver 
