\section{Endianness\IFRU{ (порядок байт)}{}}
...
\subsection{Big-endian\IFRU{ (от старшего к младшему)}{}}
...
\subsection{Little-endian\IFRU{ (от младшего к старшему)}{}}
...
\subsection{Bi-endian\IFRU{ (переключаемый порядок)}{}}
...
should convert values using} \TT{htonl()} \AndENRU \TT{htons()}\IFRU{}{ functions}.
...
\IFRU{Инструкция }{}\TT{BSWAP} \IFRU{также может использоваться для конвертирования}
