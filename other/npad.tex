...
\EN{It is an assembly language macro for label aligning by a specific boundary.}
...
кэширование, и т.д.}
\EN{That's often need for the busy labels to where control flow is often passed, e.g., loop body begin.
...
\EN{By the way, it is curious example of different \NOP variations.
...
\EN{The goal to have single idle instruction instead of couple of NOP-s,
it is accepted that is better for CPU performance.}
