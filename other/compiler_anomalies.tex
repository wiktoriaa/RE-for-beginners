\section{\RU{Аномалии компиляторов}\EN{Compiler's anomalies}}
\label{anomaly:Intel}
...
\EN{It is supposedly a code generator bug that was not found by tests, because 
resulting code works correctly anyway.}

\EN{\input{other/anomaly2_EN}}
