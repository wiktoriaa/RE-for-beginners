...
\IFRU{Специфичная для компилятора ф-ция не являющаяся обычной библиотечной ф-цией.
...
\IFRU{Полный список intrinsics от MSVC}{Full list of MSVC intrinsics}:
\url{http://msdn.microsoft.com/en-us/library/26td21ds.aspx}.
