\section{\RU{Модель памяти в 8086}\EN{8086 memory model}}
...
\EN{And probably because of reason of old software porting\footnote{The author is not 100\% sure here},
