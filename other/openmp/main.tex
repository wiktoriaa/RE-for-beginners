...
will contain a specific number of consecutive zeroes}. 
...
code which will slice the loop interval into smaller ones,
...
с MSVC}\EN{So there will be 4 threads instead of the 5 in MSVC}.
