...
\item Linux MIPS: \url{http://beginners.re/exercises/2/17/17_MIPS.tar}
...
\item Linux MIPS: \url{http://beginners.re/exercises/2/18/password2_MIPS.tar}
\end{itemize}
...
\begin{itemize}
\item Linux x64: \url{http://beginners.re/exercises/2/20/problem_Linux_x64.tar}
\item \MacOSX: \url{http://beginners.re/exercises/2/20/problem_MacOSX.tar}
\item Linux ARM Raspberry Pi: \url{http://beginners.re/exercises/2/20/problem_ARM_Raspberry_Pi.tar}
\item Linux MIPS: \url{http://beginners.re/exercises/2/20/problem_MIPS.tar}
\item Win64: \url{http://beginners.re/exercises/2/20/problem_win64.exe}
\end{itemize}
