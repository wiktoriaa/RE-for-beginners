...
\item Linux MIPS: \url{http://beginners.re/exercises/3/2/unknown_cryptosystem_MIPS.tar}
\end{itemize}
...
\item Linux MIPS: \url{http://beginners.re/exercises/3/3/unknown_utility_MIPS.tar}
\end{itemize}
...
\item Linux MIPS: \url{http://beginners.re/exercises/3/5/super_mega_protection_MIPS.tar}
