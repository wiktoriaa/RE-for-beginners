...
{By the way, what if returning value of \main function will be declared not as \IT{int} but as \IT{void}?}
...
then something random, that was stored in \EAX register at the moment of \main finish, will come into
...
{Let's back to the fact that returning value is leaved in \EAX register}.
