...
а именно сегменте данных}{So, \TT{x} variable is now global and it is localted, and, somehow,
it is now located in other segment, namely data segment} (\IT{.data}).
...
should be located somewhere in close proximity, because, there is no guarantee that linker will able to place
