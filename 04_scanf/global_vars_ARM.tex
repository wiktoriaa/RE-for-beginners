...
ведь, после включения ОЗУ, очевидно, память содержит в себе совсем не то что нужно.}
{Furthermore, data segment with constants in RAM should be initialized before, because,
after RAM turning on, obviously, memory contains not what we need.}
