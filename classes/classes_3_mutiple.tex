...
\lstinputlisting{classes/classes3_multiple.cpp}
...
\lstinputlisting{classes/classes3_1.asm}

\lstinputlisting{classes/classes3_2.asm}

\lstinputlisting{classes/classes3_3.asm}
...
\lstinputlisting{classes/classes3_4.asm}

\lstinputlisting{classes/classes3_5.asm}
...
\lstinputlisting{classes/classes3_6.asm}
...
\IT{объедененный} класс, содержащий все унаследованные поля.}
{Thus, we can say, an object of some class, inheriting from several classes, representing in memory \IT{united} class, containing all inherited fields.}
