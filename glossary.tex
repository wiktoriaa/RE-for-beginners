...
\newglossaryentry{atomic operation}
{
  ...
  это операция которая гарантированно не будет прервана другими тредами}\EN{means 
  ``indivisible'' in Greek, so an atomic operation is guaranteed not
...
\newglossaryentry{xoring}
{
  ...
  \ac{XOR}}
  \EN{often used in the English language, meaning applying the \ac{XOR} operation}}
}
...
\newglossaryentry{stack frame}
{
  ...
  аргументы ф-ции, \ac{RA}, и т.д.}\EN{A part of the stack that contains information specific to the current function:
