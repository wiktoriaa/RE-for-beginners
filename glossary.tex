...
{
  name=xoring,
  description={\IFRU{(существительное) нередко применяемое в английском языке, означает применение операции 
  \ac{XOR}}
  {(noun) often used in English language, meaning applying \ac{XOR}}}
}
