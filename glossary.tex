...
{
  name=dongle,
  description={\IFRU{Небольшое устройство подключаемое к LPT-порту (в прошлом) или к USB}
  {Dongle is a small piece of hardware connected to LPT port (in past) or to USB}.
