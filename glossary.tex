...
{
  name=\RU{указатель стека}\EN{stack pointer}\ESph{}\PTBRph{}\DE{Stapel-Zeiger}\PLph{}\ITAph{},
  description={\RU{Регистр указывающий на место в стеке}
  \EN{A register pointing to a place in the stack}\ESph{}\PTBRph{}\DE{Ein Register das auf eine Stelle im Stack zeigt}\PLph{}\ITAph{}}
}
...
\newglossaryentry{increment}
{
  ...
  description={\RU{Увеличение на 1}\EN{Increase by 1}\FR{augmenter de 1}\ESph{}\PTBRph{}\DEph{}\PLph{}\ITAph{}}
}
