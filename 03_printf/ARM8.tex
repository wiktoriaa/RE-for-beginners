...
4 записывается в \TT{R0}, затем, это значение, при помощи инструкции \TT{``STR R0, [SP,\#0x18+var\_18]''} попадает
в стек. 
\IT{var\_18} \IFRU{равен}{is} $-0x18$, \IFRU{смещение будет 0}{offset will be 0}, 
\IFRU{так что, значение из регистра \TT{R0} (4) запишется туда, куда указывает \SP}{so, value from \TT{R0} register
(4) will be written to a place \SP pointing to}.
