...
\sectionold{Patch comparison/diffing}
...
\sectionold{Library calls tracing}

\IT{ltrace}\footnote{\url{http://www.ltrace.org/}}.

\sectionold{System calls tracing}

\label{strace}
\myindex{strace}
\myindex{dtruss}
\subsectionold{strace / dtruss}
...
\chapterold{Something missing here?}
