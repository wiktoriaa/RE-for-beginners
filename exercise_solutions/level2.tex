...
\href{http://yurichev.com/RE-exercise-solutions/2/12/ROT13.c}{\IFRU{Исходный код}{Source code}}.
...
\href{http://yurichev.com/RE-exercise-solutions/2/13/LFSR.c}{\IFRU{Исходный код}{Source code}}.
...
\href{http://yurichev.com/RE-exercise-solutions/2/14/GCD.c}{\IFRU{Исходный код}{Source code}}.

\section{\Exercise 2.15}

\IFRU{Это вычисление числа Пи методом Монте-Карло}{Pi value calculation using Monte-Carlo method}.

\href{http://yurichev.com/RE-exercise-solutions/2/15/monte.c}{\IFRU{Исходный код}{Source code}}.
...
\href{http://yurichev.com/RE-exercise-solutions/2/17/CA.c}{\IFRU{Исходный код}{Source code}}.

\section{\Exercise 2.18}

\href{http://yurichev.com/RE-exercise-solutions/2/18/}{\IFRU{Исходный код}{Source code}}.

\section{\Exercise 2.19}

\href{http://yurichev.com/RE-exercise-solutions/2/19/}{\IFRU{Исходный код}{Source code}}.
