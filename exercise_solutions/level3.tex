...
\href{http://yurichev.com/RE-exercise-solutions/3/1/2_1.c}{\IFRU{Исходник на Си}{C source code}}.
...
\href{http://yurichev.com/RE-exercise-solutions/3/2/gost.c}
{\IFRU{Исходник на Си с комментариями}{Commented C source code}}.

\subsection{\Exercise 3.3}

\href{http://yurichev.com/RE-exercise-solutions/3/3/entropy.c}
{\IFRU{Исходник на Си с комментариями}{Commented C source code}}.

\subsection{\Exercise 3.4}

\href{http://yurichev.com/RE-exercise-solutions/3/4/}
...
\href{http://yurichev.com/RE-exercise-solutions/3/5/crc16_keyfile_check.c}
{\IFRU{Исходник на Си с комментариями}{Commented C source code}}.

\subsection{\Exercise 3.6}

\href{http://yurichev.com/RE-exercise-solutions/3/6/}
{\IFRU{Исходник на Си с комментариями}{Commented C source code}}.
