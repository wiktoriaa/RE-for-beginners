...
\TT{ll} \RU{в имени функции означает}\EN{in function name mean} ``long long'', \RU{т.е., 64-битный тип данных}
\EN{e.g., 64-bit data type}.
...
\EN{Multiplication and shift left procedures are the same for both signed and unsigned numbers, hence only one function 
