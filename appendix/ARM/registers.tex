...
\Reg{0}-\Reg{3} \IFRU{называются также ``scratch registers'': аргументы ф-ции обычно передаются через них,
...
% \section{Application Program Status Register (APSR)}

% TODO
% \index{ARM!\Registers!FPSCR}
% \section{Floating-Point Status and Control Register (FPPSR)}
% http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.ddi0344b/Chdfafia.html

\section{\IFRU{Регистры VPF (для чисел с плавающей точкой) и NEON}
