\sectionold{32-\RU{битный}\EN{bit} ARM (AArch32)}

\subsectionold{\RU{Регистры общего пользования}\EN{General purpose registers}}
...
\subsectionold{Current Program Status Register (CPSR)}
...
% \subsectionold{Application Program Status Register (APSR)}

% TODO
% \myindex{ARM!\Registers!FPSCR}
% \subsectionold{Floating-Point Status and Control Register (FPPSR)}
% http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.ddi0344b/Chdfafia.html

\subsectionold{\RU{Регистры VPF (для чисел с плавающей точкой) и NEON}
...
\sectionold{64-\RU{битный}\EN{bit} ARM (AArch64)}
