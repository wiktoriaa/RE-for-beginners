...
\begin{tabular}{ | l | l | }
\hline
\HeaderColor \RU{клавиша}\EN{key} & \HeaderColor \RU{значение}\EN{meaning} \\
\hline
...
Ctrl-X 	& \RU{показать ссылки на текущую функцию, метку, переменную}
	...
	& \RU{(в т.ч., в стеке)}\EN{(incl. in local stack)} \\
...
Alt-P 	& \RU{редактировать текущую функцию}\EN{edit current function} \\
		Enter 	& \RU{перейти к функции, переменной, итд.}\EN{jump to function, variable, etc.} \\
