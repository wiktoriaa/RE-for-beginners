...
\hline
\$2 \dots \$3   & \$V0 \dots \$V1 & \RU{Здесь возвращается результат ф-ции}\EN{Function result is returned here}. \\
\hline
...
\RU{Какая разница между инструкциями начинающихся с B- (BEQ, B, и т.д.) и с J- (JAL, JALR, и т.д.)?}
