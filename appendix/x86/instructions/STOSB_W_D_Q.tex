...
\EN{Together with the REP prefix, it will be repeated in a loop, count is stored in the CX/ECX/RCX register}:
...
\EN{Supposedly, it will work faster than storing 15 bytes using just one} REP STOSB).
