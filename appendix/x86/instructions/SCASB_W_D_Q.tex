...
\item[SCASB/SCASW/SCASD/SCASQ]
\IFRU{сравнить}{compare} \IFRU{байт}{byte}/
...
\label{REPNE_SCASx}
\IFRU{Эта инструкция часто используется с префиксом REPNE: продолжать сканировать буффер до тех
...
\lstinputlisting{appendix/x86/instructions/SCASB_ex1_\IFRU{ru}{en}.asm}
