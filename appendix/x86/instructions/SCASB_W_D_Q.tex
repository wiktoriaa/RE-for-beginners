...
если равны}
\EN{Hence ``NE'' in REPNE: continue to scan while the compared values are not equal and stop when equal}.
...
\EN{If we use a different AX/EAX/RAX value, the function will act like the memchr() standard C function, i.e.,
it will find a specific byte}.
