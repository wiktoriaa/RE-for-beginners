\index{x86!\Instructions!SAR}
  \item[SAR] \IFRU{Арифметический сдвиг вправо}{Arithmetic shift right}
...
\IFRU{Таким образом, бит знака всегда остается на месте}
{Hence, sign bit is always stayed at the place of} \ac{MSB}.
