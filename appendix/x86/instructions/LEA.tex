...
multiplication of element size\footnote{See also: \URLAM}.}\ESph{}\PTBRph{}\PLph{}\ITAph{}\DEph{} \\
\\
...
from memory or stores it there, but \LEA just forms an address.}\ESph{}\PTBRph{}\PLph{}\ITAph{}\DEph{} \\
\\
\RU{Тем не менее, её можно использовать для любых других вычислений}
\EN{But nevertheless, it is can be used for any other calculations}\ESph{}\PTBRph{}\PLph{}\ITAph{}\DEph{}. \\
\\
