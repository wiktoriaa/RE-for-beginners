...
multiplication of element size\footnote{See also: \URLAM}.}\ESph{}\PTBRph{} \\
\\
...
from memory or stores it there, but \LEA just forms an address.}\ESph{}\PTBRph{} \\
\\
\RU{Тем не менее, её можно использовать для любых других вычислений}
\EN{But nevertheless, it is can be used for any other calculations}\ESph{}\PTBRph{}. \\
\\
