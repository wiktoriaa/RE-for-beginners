...
когда \ac{CPU} исполняет эту инструкцию}\EN{exception will be raised when the \ac{CPU} executes this instruction}.
...
\EN{If it is not loaded, Windows will offer to run one of the registered system debuggers}.
