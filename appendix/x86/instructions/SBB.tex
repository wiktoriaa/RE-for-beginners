...
\EN{\lstinputlisting[style=customasm]{appendix/x86/instructions/SBB_example_EN.lst}}
\RU{\lstinputlisting[style=customasm]{appendix/x86/instructions/SBB_example_RU.lst}}
