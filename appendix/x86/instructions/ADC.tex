...
\index{x86!\Flags!CF}
  ...
  \EN{add values, \gls{increment} result if CF flag is set.
...
\lstinputlisting{appendix/x86/instructions/ADC_example_\LANG.lst}

\RU{Еще один пример}\EN{One more example}: \ref{sec:64bit_in_32_env}.
