...
\EN{\lstinputlisting[style=customasm]{appendix/x86/instructions/ADC_example_EN.lst}}
\RU{\lstinputlisting[style=customasm]{appendix/x86/instructions/ADC_example_RU.lst}}
