...
\EN{Together with the REP prefix, it will be repeated in a loop, the count will be stored in the CX/ECX/RCX register}:
...
\EN{Supposedly, it will work faster than copying 15 bytes using just one} REP MOVSB).
