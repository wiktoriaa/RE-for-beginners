...
\EN{Together with the REP prefix, it will be repeated in a loop, the counter is stored in the CX/ECX/RCX register,
the process will be running until the ZF flag is zero (e.g., until the compared values are equal to each
