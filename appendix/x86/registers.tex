...
\RU{Например, в \ac{RISC} процессорах, такой возможности, как правило, нет}\EN{For example, this feature
...
\section{FPU-\RU{регистры}\EN{registers}}
...
\section{SIMD-\RU{регистры}\EN{registers}}

\subsection{MMX-\RU{регистры}\EN{registers}}

8 64-\RU{битных регистров}\EN{bit registers}: MM0..MM7.

\subsection{SSE \AndENRU AVX-\RU{регистры}\EN{registers}}
