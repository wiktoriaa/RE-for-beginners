\sectionold{\RU{Регистры общего пользования}\EN{General purpose registers}}
...
\subsectionold{RBX/EBX/BX/BL}
\RegTableOne{RBX}{EBX}{BX}{BH}{BL}

\subsectionold{RCX/ECX/CX/CL}
...
\subsectionold{RDX/EDX/DX/DL}
\RegTableOne{RDX}{EDX}{DX}{DH}{DL}

\subsectionold{RSI/ESI/SI/SIL}
...
\subsectionold{R8/R8D/R8W/R8L}
\RegTableFour{R8}{R8D}{R8W}{R8L}

\subsectionold{R9/R9D/R9W/R9L}
\RegTableFour{R9}{R9D}{R9W}{R9L}

\subsectionold{R10/R10D/R10W/R10L}
\RegTableFour{R10}{R10D}{R10W}{R10L}

\subsectionold{R11/R11D/R11W/R11L}
\RegTableFour{R11}{R11D}{R11W}{R11L}

\subsectionold{R12/R12D/R12W/R12L}
\RegTableFour{R12}{R12D}{R12W}{R12L}

\subsectionold{R13/R13D/R13W/R13L}
\RegTableFour{R13}{R13D}{R13W}{R13L}

\subsectionold{R14/R14D/R14W/R14L}
\RegTableFour{R14}{R14D}{R14W}{R14L}

\subsectionold{R15/R15D/R15W/R15L}
\RegTableFour{R15}{R15D}{R15W}{R15L}

\subsectionold{RSP/ESP/SP/SPL}
...
\subsectionold{CS/DS/ES/SS/FS/GS}
...
\subsectionold{\RU{Регистр флагов}\EN{Flags register}}
...
\hline
4 (0x10) & AF (Adjust) & \RU{Существует только для работы с числами закодированными в \ac{BCD}}
			\EN{Exist solely for work with \ac{BCD}-encoded numbers} \\
\hline
...
\subsectionold{\RU{Регистр управления}\EN{Control Word}}
...
\subsectionold{\RU{Регистр статуса}\EN{Status Word}}
...
\sectionold{SIMD \registers{}}

\subsectionold{MMX \registers{}}

8 64-\RU{битных регистров}\EN{bit registers}: MM0..MM7.

\subsectionold{SSE \AndENRU AVX \registers{}}
