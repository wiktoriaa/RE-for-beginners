...
\EN{Hint: you may get some information on how values are treated with \TT{Jcc}, \MOVSX and \MOVZX instructions.}
\RU{Подсказка: вы можете получить какую-то информацию глядя на то как значения обрабатываются при помощи
...
\RU{Исходный код}\EN{Source code}: \url{http://beginners.re/exercise-solutions/per_chapter/obfuscation.c}.
