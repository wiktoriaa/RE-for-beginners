...
строке}\EN{It's easy to chech that by running the example with a different number
...
% TODO: make example of it!
\RU{Эта ф-ция меняет}\EN{This is a function, which changes the} \gls{endianness} 
