...
\RU{Ответ}\EN{Answer}: \RU{это}\EN{this is} \IT{hailstone numbers}, \RU{имеющие отношения к гипоетезе Коллатца}\EN{which relates to Collatz conjecture}\footnote{\EN{\href{http://go.yurichev.com/17107}{wikipedia}}\RU{\href{http://go.yurichev.com/17108}{wikipedia}}}.
