...
\lstinputlisting{08_switch/8_5_msvc.asm}
...
{is assembly language macro, aligning next label so that it will be stored at address aligned by 4 bytes (or 16). 
...
\lstinputlisting{08_switch/8_6_gcc.asm}
