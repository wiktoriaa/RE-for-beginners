...
is already filled the \Rzero register with some other value.}
...
{By the way, there is \IT{-S} suffix for some instructions in ARM, indicative that instruction 
will not touch the flags.}
