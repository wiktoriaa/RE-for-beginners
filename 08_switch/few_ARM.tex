...
{By the way, observant reader may ask, will \ac{BEQ} triggered right since \ADREQ before it
...
indicating the instruction will set the flags according to the result, and without it ~---
the flags will not be touched.}
