...
So, if you see the instruction somewhere in code, it is most likely this is manually written piece of assembler code.}
...
\lstinputlisting{loops/loops_2.c}
...
\lstinputlisting{\IFRU{loops/9_1_ru_gcc.asm}{loops/9_1_en_gcc.asm}}
...
\lstinputlisting{loops/9_1_gcc_O3.asm}
